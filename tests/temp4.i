...
int main() {
    ...
    for (var = 0; var != 10; var++) {
        ...
        ptr[0] = var;
        printf("1: %d is the value.", *ptr);
        free(ptr);
        printf("2: %d is the value.", *ptr);
        ptr = ptr2;
        printf("3: %d is the value.", *ptr);
        free(ptr2);
        printf("4: %d is the value.", *ptr2);
        *ptr2 = var;
        if (ptr2 == ((void *)0)) {
            printf("\n ptr2 is null now.");
        } else {
        ...
        printf("5: %d is the value.", *ptr);
        ptr = ((void *)0);
        printf("6: %d is the value.", *ptr);
    }
}
