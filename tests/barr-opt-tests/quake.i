...
double phi0(double t)
{
 double value;
 if (t <= Exc.t0) {
  value = 0.5 / 3.141592653589793238 * (2.0 * 3.141592653589793238 * t / Exc.t0 - sin(2.0 * 3.141592653589793238 * t / Exc.t0));
  return value;
 }
 else
  return 1.0;
...
double phi1(double t)
{
 double value;
 if (t <= Exc.t0) {
  value = (1.0 - cos(2.0 * 3.141592653589793238 * t / Exc.t0)) / Exc.t0;
  return value;
 }
 else
  return 0.0;
...
double phi2(double t)
{
 double value;
 if (t <= Exc.t0) {
  value = 2.0 * 3.141592653589793238 / Exc.t0 / Exc.t0 * sin(2.0 * 3.141592653589793238 * t / Exc.t0);
  return value;
 }
 else
  return 0.0;
...
void mem_init(void) {
 ...
 w1 = (smallarray_t **) malloc(numthreads * sizeof(struct smallarray_s *));
