...
int main(int argc, char** argv)
{
  ...
  double float_n;
  double (*data)[1000 + 0][1000 + 0]; data = (double(*)[1000 + 0][1000 + 0])polybench_alloc_data ((1000 + 0) * (1000 + 0), sizeof(double));;
  double (*symmat)[1000 + 0][1000 + 0]; symmat = (double(*)[1000 + 0][1000 + 0])polybench_alloc_data ((1000 + 0) * (1000 + 0), sizeof(double));;
  double (*mean)[1000 + 0]; mean = (double(*)[1000 + 0])polybench_alloc_data (1000 + 0, sizeof(double));;
  double (*stddev)[1000 + 0]; stddev = (double(*)[1000 + 0])polybench_alloc_data (1000 + 0, sizeof(double));;
  ...
  if (argc > 42 && ! strcmp(argv[0], "")) print_array(m, *symmat);
