...
# 1 "./stencils/fdtd-apml/fdtd-apml.h" 1
# 8 "fdtd-apml.c" 2
...
int main(int argc, char** argv)
{
  ...
  double mui;
  double ch;
  double (*Ax)[256 +1 + 0][256 +1 + 0]; Ax = (double(*)[256 +1 + 0][256 +1 + 0])polybench_alloc_data ((256 +1 + 0) * (256 +1 + 0), sizeof(double));;
  double (*Ry)[256 +1 + 0][256 +1 + 0]; Ry = (double(*)[256 +1 + 0][256 +1 + 0])polybench_alloc_data ((256 +1 + 0) * (256 +1 + 0), sizeof(double));;
  double (*clf)[256 +1 + 0][256 +1 + 0]; clf = (double(*)[256 +1 + 0][256 +1 + 0])polybench_alloc_data ((256 +1 + 0) * (256 +1 + 0), sizeof(double));;
  double (*tmp)[256 +1 + 0][256 +1 + 0]; tmp = (double(*)[256 +1 + 0][256 +1 + 0])polybench_alloc_data ((256 +1 + 0) * (256 +1 + 0), sizeof(double));;
  double (*Bza)[256 +1 + 0][256 +1 + 0][256 +1 + 0]; Bza = (double(*)[256 +1 + 0][256 +1 + 0][256 +1 + 0])polybench_alloc_data ((256 +1 + 0) * (256 +1 + 0) * (256 +1 + 0), sizeof(double));;
  double (*Ex)[256 +1 + 0][256 +1 + 0][256 +1 + 0]; Ex = (double(*)[256 +1 + 0][256 +1 + 0][256 +1 + 0])polybench_alloc_data ((256 +1 + 0) * (256 +1 + 0) * (256 +1 + 0), sizeof(double));;
  double (*Ey)[256 +1 + 0][256 +1 + 0][256 +1 + 0]; Ey = (double(*)[256 +1 + 0][256 +1 + 0][256 +1 + 0])polybench_alloc_data ((256 +1 + 0) * (256 +1 + 0) * (256 +1 + 0), sizeof(double));;
  double (*Hz)[256 +1 + 0][256 +1 + 0][256 +1 + 0]; Hz = (double(*)[256 +1 + 0][256 +1 + 0][256 +1 + 0])polybench_alloc_data ((256 +1 + 0) * (256 +1 + 0) * (256 +1 + 0), sizeof(double));;
  double (*czm)[256 +1 + 0]; czm = (double(*)[256 +1 + 0])polybench_alloc_data (256 +1 + 0, sizeof(double));;
  double (*czp)[256 +1 + 0]; czp = (double(*)[256 +1 + 0])polybench_alloc_data (256 +1 + 0, sizeof(double));;
  double (*cxmh)[256 +1 + 0]; cxmh = (double(*)[256 +1 + 0])polybench_alloc_data (256 +1 + 0, sizeof(double));;
  double (*cxph)[256 +1 + 0]; cxph = (double(*)[256 +1 + 0])polybench_alloc_data (256 +1 + 0, sizeof(double));;
  double (*cymh)[256 +1 + 0]; cymh = (double(*)[256 +1 + 0])polybench_alloc_data (256 +1 + 0, sizeof(double));;
  double (*cyph)[256 +1 + 0]; cyph = (double(*)[256 +1 + 0])polybench_alloc_data (256 +1 + 0, sizeof(double));;
  ...
  if (argc > 42 && ! strcmp(argv[0], "")) print_array(cz, cxm, cym, *Bza, *Ex, *Ey, *Hz)
