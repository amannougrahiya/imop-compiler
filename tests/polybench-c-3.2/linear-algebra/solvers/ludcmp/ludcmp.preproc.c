...
int main(int argc, char** argv)
{
  ...
  double (*A)[1024 +1 + 0][1024 +1 + 0]; A = (double(*)[1024 +1 + 0][1024 +1 + 0])polybench_alloc_data ((1024 +1 + 0) * (1024 +1 + 0), sizeof(double));;
  double (*b)[1024 +1 + 0]; b = (double(*)[1024 +1 + 0])polybench_alloc_data (1024 +1 + 0, sizeof(double));;
  double (*x)[1024 +1 + 0]; x = (double(*)[1024 +1 + 0])polybench_alloc_data (1024 +1 + 0, sizeof(double));;
  double (*y)[1024 +1 + 0]; y = (double(*)[1024 +1 + 0])polybench_alloc_data (1024 +1 + 0, sizeof(double));;
