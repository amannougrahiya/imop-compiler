...
int main(int argc, char** argv)
{
  ...
  double (*y)[4000 + 0][4000 + 0]; y = (double(*)[4000 + 0][4000 + 0])polybench_alloc_data ((4000 + 0) * (4000 + 0), sizeof(double));;
  double (*sum)[4000 + 0][4000 + 0]; sum = (double(*)[4000 + 0][4000 + 0])polybench_alloc_data ((4000 + 0) * (4000 + 0), sizeof(double));;
  double (*alpha)[4000 + 0]; alpha = (double(*)[4000 + 0])polybench_alloc_data (4000 + 0, sizeof(double));;
  double (*beta)[4000 + 0]; beta = (double(*)[4000 + 0])polybench_alloc_data (4000 + 0, sizeof(double));;
  double (*r)[4000 + 0]; r = (double(*)[4000 + 0])polybench_alloc_data (4000 + 0, sizeof(double));;
  double (*out)[4000 + 0]; out = (double(*)[4000 + 0])polybench_alloc_data (4000 + 0, sizeof(double));;
  ...
  if (argc > 42 && ! strcmp(argv[0], "")) print_array(n, *out);
