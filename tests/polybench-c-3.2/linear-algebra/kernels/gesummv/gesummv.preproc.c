...
# 1 "./linear-algebra/kernels/gesummv/gesummv.h" 1
# 8 "gesummv.c" 2
...
int main(int argc, char** argv)
{
  ...
  double (*B)[4000 + 0][4000 + 0]; B = (double(*)[4000 + 0][4000 + 0])polybench_alloc_data ((4000 + 0) * (4000 + 0), sizeof(double));;
  double (*tmp)[4000 + 0]; tmp = (double(*)[4000 + 0])polybench_alloc_data (4000 + 0, sizeof(double));;
