...
# 1 "./medley/reg_detect/reg_detect.h" 1
# 8 "reg_detect.c" 2
...
int main(int argc, char** argv)
{
  ...
  int (*sum_tang)[6 + 0][6 + 0]; sum_tang = (int(*)[6 + 0][6 + 0])polybench_alloc_data ((6 + 0) * (6 + 0), sizeof(int));;
  int (*mean)[6 + 0][6 + 0]; mean = (int(*)[6 + 0][6 + 0])polybench_alloc_data ((6 + 0) * (6 + 0), sizeof(int));;
  int (*path)[6 + 0][6 + 0]; path = (int(*)[6 + 0][6 + 0])polybench_alloc_data ((6 + 0) * (6 + 0), sizeof(int));;
  int (*diff)[6 + 0][6 + 0][64 + 0]; diff = (int(*)[6 + 0][6 + 0][64 + 0])polybench_alloc_data ((6 + 0) * (6 + 0) * (64 + 0), sizeof(int));;
  int (*sum_diff)[6 + 0][6 + 0][64 + 0]; sum_diff = (int(*)[6 + 0][6 + 0][64 + 0])polybench_alloc_data ((6 + 0) * (6 + 0) * (64 + 0), sizeof(int));;
  ...
  if (argc > 42 && ! strcmp(argv[0], "")) print_array(maxgrid, *path);
