...
int main(int argc, char **argv) {
 ...
 class = 'U';
    ...
    makea(naa, nzz, a, colidx, rowstr, 15,
   firstrow, lastrow, firstcol, lastcol,
   1.0e-1, arow, acol, aelt, v, iv, 110.0);
...
#pragma omp master
 ...
 printf(" NO VERIFICATION PERFORMED\n");
    ...
    if ( t != 0.0 ) {
 mflops = (2.0*75*150000)
     * (3.0+(15*(15 +1)) + 25.0*(5.0+(15*(15 +1))) + 3.0 )
     / t / 1000000.0;
    } else {
 mflops = 0.0;
    }
    c_print_results("CG", class, 150000, 0, 0, 75, nthreads, t,
