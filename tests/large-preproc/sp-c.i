...
static double u [5][162/2*2+1][162/2*2+1][162/2*2+1],
       us [162/2*2+1][162/2*2+1][162/2*2+1],
              vs [162/2*2+1][162/2*2+1][162/2*2+1],
              ws [162/2*2+1][162/2*2+1][162/2*2+1],
              qs [162/2*2+1][162/2*2+1][162/2*2+1],
              ainv [162/2*2+1][162/2*2+1][162/2*2+1],
              rho_i [162/2*2+1][162/2*2+1][162/2*2+1],
              speed [162/2*2+1][162/2*2+1][162/2*2+1],
       square [162/2*2+1][162/2*2+1][162/2*2+1],
              rhs [5][162/2*2+1][162/2*2+1][162/2*2+1],
              forcing [5][162/2*2+1][162/2*2+1][162/2*2+1],
              lhs [15][162/2*2+1][162/2*2+1][162/2*2+1];
static double cv[162], rhon[162],
              rhos[162], rhoq[162],
              cuf[162], q[162],
              ue[5][162], buf[5][162];
...
#pragma omp master
  ...
  if (tmax != 0) {
    mflops = ( 881.174 * pow((double)162, 3.0)
        - 4683.91 * (((double)162)*((double)162))
        + 11484.5 * (double)162
