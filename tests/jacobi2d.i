...
void print_array()
{
    ...
    for (i=0; i<2000; i++) {
        for (j=0; j<2000; j++) {
            fprintf(__stderrp, "%lf ", a[i][j]);
            if (j%80 == 20) fprintf(__stderrp, "\n");
        }
    }
    fprintf(__stderrp, "\n");
}
...
if ((2000 >= 4) && (1000 >= 1)) {
  for (t1=0;t1<=floor(((double)(3*1000 +2000 -4))/((double)(32)));t1++) {
    lbp=((ceil(((double)(2*t1))/((double)(3)))) > (ceil(((double)(32*t1-1000 +1))/((double)(32))))? (ceil(((double)(2*t1))/((double)(3)))) : (ceil(((double)(32*t1-1000 +1))/((double)(32)))));
    ubp=((((floor(((double)(2*1000 +2000 -3))/((double)(32)))) < (floor(((double)(64*t1+2000 +61))/((double)(96))))? (floor(((double)(2*1000 +2000 -3))/((double)(32)))) : (floor(((double)(64*t1+2000 +61))/((double)(96)))))) < (t1)? (((floor(((double)(2*1000 +2000 -3))/((double)(32)))) < (floor(((double)(64*t1+2000 +61))/((double)(96))))? (floor(((double)(2*1000 +2000 -3))/((double)(32)))) : (floor(((double)(64*t1+2000 +61))/((double)(96)))))) : (t1));
#pragma omp parallel for private(lbv,ubv,t3,t4,t5,t6)
    for (t2=lbp;t2<=ubp;t2++) {
      for (t3=((ceil(((double)(32*t2-2000 -27))/((double)(32)))) > (2*t1-2*t2)? (ceil(((double)(32*t2-2000 -27))/((double)(32)))) : (2*t1-2*t2));t3<=((((floor(((double)(2*1000 +2000 -3))/((double)(32)))) < (floor(((double)(32*t2+2000 +27))/((double)(32))))? (floor(((double)(2*1000 +2000 -3))/((double)(32)))) : (floor(((double)(32*t2+2000 +27))/((double)(32)))))) < (floor(((double)(64*t1-64*t2+2000 +61))/((double)(32))))? (((floor(((double)(2*1000 +2000 -3))/((double)(32)))) < (floor(((double)(32*t2+2000 +27))/((double)(32))))? (floor(((double)(2*1000 +2000 -3))/((double)(32)))) : (floor(((double)(32*t2+2000 +27))/((double)(32)))))) : (floor(((double)(64*t1-64*t2+2000 +61))/((double)(32)))));t3++) {
        if ((t1 <= floor(((double)(64*t2+32*t3-2000 +1))/((double)(64)))) && (t2 <= t3-1)) {
          if ((2000 +1)%2 == 0) {
            for (t5=((32*t2) > (32*t3-2000 +4)? (32*t2) : (32*t3-2000 +4));t5<=32*t2+31;t5++) {
              a[(-32*t3+t5+2000 -2)][(2000 -2)]=b[(-32*t3+t5+2000 -2)][(2000 -2)];;
            }
          }
        }
        if ((t1 <= floor(((double)(96*t2-2000 +1))/((double)(64)))) && (t2 >= t3)) {
          if ((2000 +1)%2 == 0) {
            for (t6=((32*t3) > (32*t2-2000 +4)? (32*t3) : (32*t2-2000 +4));t6<=((32*t2) < (32*t3+31)? (32*t2) : (32*t3+31));t6++) {
              a[(2000 -2)][(-32*t2+t6+2000 -2)]=b[(2000 -2)][(-32*t2+t6+2000 -2)];;
            }
          }
        }
        if ((2000 == 4) && (t2 == t3)) {
          for (t4=((32*t1-32*t2) > (16*t2-1)? (32*t1-32*t2) : (16*t2-1));t4<=((((1000 -1) < (16*t2+14)? (1000 -1) : (16*t2+14))) < (32*t1-32*t2+31)? (((1000 -1) < (16*t2+14)? (1000 -1) : (16*t2+14))) : (32*t1-32*t2+31));t4++) {
            b[2][2]= 0.2*(a[2][2]+a[2][2 -1]+a[2][1+2]+a[1+2][2]+a[2 -1][2]);;
            a[2][2]=b[2][2];;
          }
        }
        if (t2 == t3) {
          for (t4=((ceil(((double)(32*t2-2000 +2))/((double)(2)))) > (32*t1-32*t2)? (ceil(((double)(32*t2-2000 +2))/((double)(2)))) : (32*t1-32*t2));t4<=((((((floor(((double)(32*t2-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t2-2000 +32))/((double)(2)))) : (1000 -1))) < (16*t2-2)? (((floor(((double)(32*t2-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t2-2000 +32))/((double)(2)))) : (1000 -1))) : (16*t2-2))) < (32*t1-32*t2+31)? (((((floor(((double)(32*t2-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t2-2000 +32))/((double)(2)))) : (1000 -1))) < (16*t2-2)? (((floor(((double)(32*t2-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t2-2000 +32))/((double)(2)))) : (1000 -1))) : (16*t2-2))) : (32*t1-32*t2+31));t4++) {
            for (t5=32*t2;t5<=2*t4+2000 -2;t5++) {
              for (t6=32*t2;t6<=2*t4+2000 -2;t6++) {
              ...
              a[(-2*t4+t5-1)][(2000 -2)]=b[(-2*t4+t5-1)][(2000 -2)];;
            }
            for (t6=32*t2;t6<=2*t4+2000 -1;t6++) {
              a[(2000 -2)][(-2*t4+t6-1)]=b[(2000 -2)][(-2*t4+t6-1)];;
            }
          }
        }
        for (t4=((((ceil(((double)(32*t2-2000 +33))/((double)(2)))) > (ceil(((double)(32*t3-2000 +2))/((double)(2))))? (ceil(((double)(32*t2-2000 +33))/((double)(2)))) : (ceil(((double)(32*t3-2000 +2))/((double)(2)))))) > (32*t1-32*t2)? (((ceil(((double)(32*t2-2000 +33))/((double)(2)))) > (ceil(((double)(32*t3-2000 +2))/((double)(2))))? (ceil(((double)(32*t2-2000 +33))/((double)(2)))) : (ceil(((double)(32*t3-2000 +2))/((double)(2)))))) : (32*t1-32*t2));t4<=((((((floor(((double)(32*t3-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t3-2000 +32))/((double)(2)))) : (1000 -1))) < (16*t2-2)? (((floor(((double)(32*t3-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t3-2000 +32))/((double)(2)))) : (1000 -1))) : (16*t2-2))) < (32*t1-32*t2+31)? (((((floor(((double)(32*t3-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t3-2000 +32))/((double)(2)))) : (1000 -1))) < (16*t2-2)? (((floor(((double)(32*t3-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t3-2000 +32))/((double)(2)))) : (1000 -1))) : (16*t2-2))) : (32*t1-32*t2+31));t4++) {
          for (t5=32*t2;t5<=32*t2+31;t5++) {
            for (t6=32*t3;t6<=2*t4+2000 -2;t6++) {
              b[(-2*t4+t5)][(-2*t4+t6)]= 0.2*(a[(-2*t4+t5)][(-2*t4+t6)]+a[(-2*t4+t5)][(-2*t4+t6)-1]+a[(-2*t4+t5)][1+(-2*t4+t6)]+a[1+(-2*t4+t5)][(-2*t4+t6)]+a[(-2*t4+t5)-1][(-2*t4+t6)]);;
              a[(-2*t4+t5-1)][(-2*t4+t6-1)]=b[(-2*t4+t5-1)][(-2*t4+t6-1)];;
            }
            a[(-2*t4+t5-1)][(2000 -2)]=b[(-2*t4+t5-1)][(2000 -2)];;
        ...
        for (t4=((((ceil(((double)(32*t2-2000 +2))/((double)(2)))) > (ceil(((double)(32*t3-2000 +33))/((double)(2))))? (ceil(((double)(32*t2-2000 +2))/((double)(2)))) : (ceil(((double)(32*t3-2000 +33))/((double)(2)))))) > (32*t1-32*t2)? (((ceil(((double)(32*t2-2000 +2))/((double)(2)))) > (ceil(((double)(32*t3-2000 +33))/((double)(2))))? (ceil(((double)(32*t2-2000 +2))/((double)(2)))) : (ceil(((double)(32*t3-2000 +33))/((double)(2)))))) : (32*t1-32*t2));t4<=((((((floor(((double)(32*t2-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t2-2000 +32))/((double)(2)))) : (1000 -1))) < (16*t3-2)? (((floor(((double)(32*t2-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t2-2000 +32))/((double)(2)))) : (1000 -1))) : (16*t3-2))) < (32*t1-32*t2+31)? (((((floor(((double)(32*t2-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t2-2000 +32))/((double)(2)))) : (1000 -1))) < (16*t3-2)? (((floor(((double)(32*t2-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t2-2000 +32))/((double)(2)))) : (1000 -1))) : (16*t3-2))) : (32*t1-32*t2+31));t4++) {
          for (t5=32*t2;t5<=2*t4+2000 -2;t5++) {
        ...
        for (t4=((((ceil(((double)(32*t2-2000 +33))/((double)(2)))) > (ceil(((double)(32*t3-2000 +33))/((double)(2))))? (ceil(((double)(32*t2-2000 +33))/((double)(2)))) : (ceil(((double)(32*t3-2000 +33))/((double)(2)))))) > (32*t1-32*t2)? (((ceil(((double)(32*t2-2000 +33))/((double)(2)))) > (ceil(((double)(32*t3-2000 +33))/((double)(2))))? (ceil(((double)(32*t2-2000 +33))/((double)(2)))) : (ceil(((double)(32*t3-2000 +33))/((double)(2)))))) : (32*t1-32*t2));t4<=((((((1000 -1) < (16*t2-2)? (1000 -1) : (16*t2-2))) < (16*t3-2)? (((1000 -1) < (16*t2-2)? (1000 -1) : (16*t2-2))) : (16*t3-2))) < (32*t1-32*t2+31)? (((((1000 -1) < (16*t2-2)? (1000 -1) : (16*t2-2))) < (16*t3-2)? (((1000 -1) < (16*t2-2)? (1000 -1) : (16*t2-2))) : (16*t3-2))) : (32*t1-32*t2+31));t4++) {
          for (t5=32*t2;t5<=32*t2+31;t5++) {
            for (t6=32*t3;t6<=32*t3+31;t6++) {
              b[(-2*t4+t5)][(-2*t4+t6)]= 0.2*(a[(-2*t4+t5)][(-2*t4+t6)]+a[(-2*t4+t5)][(-2*t4+t6)-1]+a[(-2*t4+t5)][1+(-2*t4+t6)]+a[1+(-2*t4+t5)][(-2*t4+t6)]+a[(-2*t4+t5)-1][(-2*t4+t6)]);;
              a[(-2*t4+t5-1)][(-2*t4+t6-1)]=b[(-2*t4+t5-1)][(-2*t4+t6-1)];;
        ...
        if ((2000 >= 5) && (t2 == t3)) {
          for (t4=((32*t1-32*t2) > (16*t2-1)? (32*t1-32*t2) : (16*t2-1));t4<=((((floor(((double)(32*t2-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t2-2000 +32))/((double)(2)))) : (1000 -1))) < (32*t1-32*t2+31)? (((floor(((double)(32*t2-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t2-2000 +32))/((double)(2)))) : (1000 -1))) : (32*t1-32*t2+31));t4++) {
            for (t6=2*t4+2;t6<=2*t4+2000 -2;t6++) {
              b[2][(-2*t4+t6)]= 0.2*(a[2][(-2*t4+t6)]+a[2][(-2*t4+t6)-1]+a[2][1+(-2*t4+t6)]+a[1+2][(-2*t4+t6)]+a[2 -1][(-2*t4+t6)]);;
            }
            for (t5=2*t4+3;t5<=2*t4+2000 -2;t5++) {
              b[(-2*t4+t5)][2]= 0.2*(a[(-2*t4+t5)][2]+a[(-2*t4+t5)][2 -1]+a[(-2*t4+t5)][1+2]+a[1+(-2*t4+t5)][2]+a[(-2*t4+t5)-1][2]);;
              for (t6=2*t4+3;t6<=2*t4+2000 -2;t6++) {
                b[(-2*t4+t5)][(-2*t4+t6)]= 0.2*(a[(-2*t4+t5)][(-2*t4+t6)]+a[(-2*t4+t5)][(-2*t4+t6)-1]+a[(-2*t4+t5)][1+(-2*t4+t6)]+a[1+(-2*t4+t5)][(-2*t4+t6)]+a[(-2*t4+t5)-1][(-2*t4+t6)]);;
                a[(-2*t4+t5-1)][(-2*t4+t6-1)]=b[(-2*t4+t5-1)][(-2*t4+t6-1)];;
              }
              a[(-2*t4+t5-1)][(2000 -2)]=b[(-2*t4+t5-1)][(2000 -2)];;
            }
            for (t6=2*t4+3;t6<=2*t4+2000 -1;t6++) {
              a[(2000 -2)][(-2*t4+t6-1)]=b[(2000 -2)][(-2*t4+t6-1)];;
            }
          }
        }
        if (t2 == t3) {
          for (t4=((((ceil(((double)(32*t2-2000 +33))/((double)(2)))) > (32*t1-32*t2)? (ceil(((double)(32*t2-2000 +33))/((double)(2)))) : (32*t1-32*t2))) > (16*t2-1)? (((ceil(((double)(32*t2-2000 +33))/((double)(2)))) > (32*t1-32*t2)? (ceil(((double)(32*t2-2000 +33))/((double)(2)))) : (32*t1-32*t2))) : (16*t2-1));t4<=((((1000 -1) < (16*t2+14)? (1000 -1) : (16*t2+14))) < (32*t1-32*t2+31)? (((1000 -1) < (16*t2+14)? (1000 -1) : (16*t2+14))) : (32*t1-32*t2+31));t4++) {
        ...
        for (t4=((((ceil(((double)(32*t3-2000 +2))/((double)(2)))) > (32*t1-32*t2)? (ceil(((double)(32*t3-2000 +2))/((double)(2)))) : (32*t1-32*t2))) > (16*t2-1)? (((ceil(((double)(32*t3-2000 +2))/((double)(2)))) > (32*t1-32*t2)? (ceil(((double)(32*t3-2000 +2))/((double)(2)))) : (32*t1-32*t2))) : (16*t2-1));t4<=((((((((floor(((double)(32*t3-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t3-2000 +32))/((double)(2)))) : (1000 -1))) < (16*t2+14)? (((floor(((double)(32*t3-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t3-2000 +32))/((double)(2)))) : (1000 -1))) : (16*t2+14))) < (16*t3-2)? (((((floor(((double)(32*t3-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t3-2000 +32))/((double)(2)))) : (1000 -1))) < (16*t2+14)? (((floor(((double)(32*t3-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t3-2000 +32))/((double)(2)))) : (1000 -1))) : (16*t2+14))) : (16*t3-2))) < (32*t1-32*t2+31)? (((((((floor(((double)(32*t3-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t3-2000 +32))/((double)(2)))) : (1000 -1))) < (16*t2+14)? (((floor(((double)(32*t3-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t3-2000 +32))/((double)(2)))) : (1000 -1))) : (16*t2+14))) < (16*t3-2)? (((((floor(((double)(32*t3-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t3-2000 +32))/((double)(2)))) : (1000 -1))) < (16*t2+14)? (((floor(((double)(32*t3-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t3-2000 +32))/((double)(2)))) : (1000 -1))) : (16*t2+14))) : (16*t3-2))) : (32*t1-32*t2+31));t4++) {
          for (t6=32*t3;t6<=2*t4+2000 -2;t6++) {
            b[2][(-2*t4+t6)]= 0.2*(a[2][(-2*t4+t6)]+a[2][(-2*t4+t6)-1]+a[2][1+(-2*t4+t6)]+a[1+2][(-2*t4+t6)]+a[2 -1][(-2*t4+t6)]);;
          }
          for (t5=2*t4+3;t5<=32*t2+31;t5++) {
        ...
        for (t4=((((ceil(((double)(32*t3-2000 +33))/((double)(2)))) > (32*t1-32*t2)? (ceil(((double)(32*t3-2000 +33))/((double)(2)))) : (32*t1-32*t2))) > (16*t2-1)? (((ceil(((double)(32*t3-2000 +33))/((double)(2)))) > (32*t1-32*t2)? (ceil(((double)(32*t3-2000 +33))/((double)(2)))) : (32*t1-32*t2))) : (16*t2-1));t4<=((((((1000 -1) < (16*t2+14)? (1000 -1) : (16*t2+14))) < (16*t3-2)? (((1000 -1) < (16*t2+14)? (1000 -1) : (16*t2+14))) : (16*t3-2))) < (32*t1-32*t2+31)? (((((1000 -1) < (16*t2+14)? (1000 -1) : (16*t2+14))) < (16*t3-2)? (((1000 -1) < (16*t2+14)? (1000 -1) : (16*t2+14))) : (16*t3-2))) : (32*t1-32*t2+31));t4++) {
          for (t6=32*t3;t6<=32*t3+31;t6++) {
            b[2][(-2*t4+t6)]= 0.2*(a[2][(-2*t4+t6)]+a[2][(-2*t4+t6)-1]+a[2][1+(-2*t4+t6)]+a[1+2][(-2*t4+t6)]+a[2 -1][(-2*t4+t6)]);;
          }
          for (t5=2*t4+3;t5<=32*t2+31;t5++) {
        ...
        for (t4=((((ceil(((double)(32*t2-2000 +2))/((double)(2)))) > (32*t1-32*t2)? (ceil(((double)(32*t2-2000 +2))/((double)(2)))) : (32*t1-32*t2))) > (16*t3-1)? (((ceil(((double)(32*t2-2000 +2))/((double)(2)))) > (32*t1-32*t2)? (ceil(((double)(32*t2-2000 +2))/((double)(2)))) : (32*t1-32*t2))) : (16*t3-1));t4<=((((((((floor(((double)(32*t2-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t2-2000 +32))/((double)(2)))) : (1000 -1))) < (16*t2-2)? (((floor(((double)(32*t2-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t2-2000 +32))/((double)(2)))) : (1000 -1))) : (16*t2-2))) < (16*t3+14)? (((((floor(((double)(32*t2-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t2-2000 +32))/((double)(2)))) : (1000 -1))) < (16*t2-2)? (((floor(((double)(32*t2-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t2-2000 +32))/((double)(2)))) : (1000 -1))) : (16*t2-2))) : (16*t3+14))) < (32*t1-32*t2+31)? (((((((floor(((double)(32*t2-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t2-2000 +32))/((double)(2)))) : (1000 -1))) < (16*t2-2)? (((floor(((double)(32*t2-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t2-2000 +32))/((double)(2)))) : (1000 -1))) : (16*t2-2))) < (16*t3+14)? (((((floor(((double)(32*t2-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t2-2000 +32))/((double)(2)))) : (1000 -1))) < (16*t2-2)? (((floor(((double)(32*t2-2000 +32))/((double)(2)))) < (1000 -1)? (floor(((double)(32*t2-2000 +32))/((double)(2)))) : (1000 -1))) : (16*t2-2))) : (16*t3+14))) : (32*t1-32*t2+31));t4++) {
          for (t5=32*t2;t5<=2*t4+2000 -2;t5++) {
            b[(-2*t4+t5)][2]= 0.2*(a[(-2*t4+t5)][2]+a[(-2*t4+t5)][2 -1]+a[(-2*t4+t5)][1+2]+a[1+(-2*t4+t5)][2]+a[(-2*t4+t5)-1][2]);;
        ...
        for (t4=((((ceil(((double)(32*t2-2000 +33))/((double)(2)))) > (32*t1-32*t2)? (ceil(((double)(32*t2-2000 +33))/((double)(2)))) : (32*t1-32*t2))) > (16*t3-1)? (((ceil(((double)(32*t2-2000 +33))/((double)(2)))) > (32*t1-32*t2)? (ceil(((double)(32*t2-2000 +33))/((double)(2)))) : (32*t1-32*t2))) : (16*t3-1));t4<=((((((1000 -1) < (16*t2-2)? (1000 -1) : (16*t2-2))) < (16*t3+14)? (((1000 -1) < (16*t2-2)? (1000 -1) : (16*t2-2))) : (16*t3+14))) < (32*t1-32*t2+31)? (((((1000 -1) < (16*t2-2)? (1000 -1) : (16*t2-2))) < (16*t3+14)? (((1000 -1) < (16*t2-2)? (1000 -1) : (16*t2-2))) : (16*t3+14))) : (32*t1-32*t2+31));t4++) {
          for (t5=32*t2;t5<=32*t2+31;t5++) {
            b[(-2*t4+t5)][2]= 0.2*(a[(-2*t4+t5)][2]+a[(-2*t4+t5)][2 -1]+a[(-2*t4+t5)][1+2]+a[1+(-2*t4+t5)][2]+a[(-2*t4+t5)-1][2]);;
            for (t6=2*t4+3;t6<=32*t3+31;t6++) {
              b[(-2*t4+t5)][(-2*t4+t6)]= 0.2*(a[(-2*t4+t5)][(-2*t4+t6)]+a[(-2*t4+t5)][(-2*t4+t6)-1]+a[(-2*t4+t5)][1+(-2*t4+t6)]+a[1+(-2*t4+t5)][(-2*t4+t6)]+a[(-2*t4+t5)-1][(-2*t4+t6)]);;
