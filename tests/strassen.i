        ...
        unsigned RowWidthC, unsigned RowWidthA, unsigned RowWidthB, int Depth)
{
    ...
    StartHeap = Heap = malloc(QuadrantSizeInBytes * 11);
    if ( ((PTR) Heap) & 31) {
    ...
    for (Row = 0; Row < QuadrantSize; Row++) {
        for (Column = 0; Column < QuadrantSize; Column++) {
            (* (REAL *) ( ((PTR) S1) + TempMatrixOffset ) ) = (* (REALPTR) ( ((PTR) A21) + MatrixOffsetA ) ) + (* (REALPTR) ( ((PTR) A22) + MatrixOffsetA ) );
            (* (REALPTR) ( ((PTR) S2) + TempMatrixOffset ) ) = (* (REALPTR) ( ((PTR) S1) + TempMatrixOffset ) ) - (* (REALPTR) ( ((PTR) A) + MatrixOffsetA ) );
            (* (REALPTR) ( ((PTR) S4) + TempMatrixOffset ) ) = (* (REALPTR) ( ((PTR) A12) + MatrixOffsetA ) ) - (* (REALPTR) ( ((PTR) S2) + TempMatrixOffset ) );
            (* (REALPTR) ( ((PTR) S5) + TempMatrixOffset ) ) = (* (REALPTR) ( ((PTR) B12) + MatrixOffsetB ) ) - (* (REALPTR) ( ((PTR) B) + MatrixOffsetB ) );
            (* (REALPTR) ( ((PTR) S6) + TempMatrixOffset ) ) = (* (REALPTR) ( ((PTR) B22) + MatrixOffsetB ) ) - (* (REALPTR) ( ((PTR) S5) + TempMatrixOffset ) );
            (* (REALPTR) ( ((PTR) S8) + TempMatrixOffset ) ) = (* (REALPTR) ( ((PTR) S6) + TempMatrixOffset ) ) - (* (REALPTR) ( ((PTR) B21) + MatrixOffsetB ) );
            (* (REALPTR) ( ((PTR) S3) + TempMatrixOffset ) ) = (* (REALPTR) ( ((PTR) A) + MatrixOffsetA ) ) - (* (REALPTR) ( ((PTR) A21) + MatrixOffsetA ) );
            (* (REALPTR) ( ((PTR) S7) + TempMatrixOffset ) ) = (* (REALPTR) ( ((PTR) B22) + MatrixOffsetB ) ) - (* (REALPTR) ( ((PTR) B12) + MatrixOffsetB ) );
...
int compare_matrix(int n, REAL *A, int an, REAL *B, int bn)
{
    ...
    for (i = 0; i < n; ++i)
        for (j = 0; j < n; ++j) {
            ...
            c = c / (A[(i)*(an)+(j)]);
            if (c > (1.0E-6)) {
                { if ( bots_verbose_mode >= BOTS_VERBOSE_DEFAULT ) { fprintf(stdout, "Strassen: Wrong answer!\n"); } };
                return 2;
            }
        }
    return 1;
...
void strassen_main_par(REAL *A, REAL *B, REAL *C, int n)
{
    { if ( bots_verbose_mode >= BOTS_VERBOSE_DEFAULT ) { fprintf(stdout, "Computing parallel Strassen algorithm (n=%d) " , n); } };
...
void strassen_main_seq(REAL *A, REAL *B, REAL *C, int n)
{
    { if ( bots_verbose_mode >= BOTS_VERBOSE_DEFAULT ) { fprintf(stdout, "Computing sequential Strassen algorithm (n=%d) " , n); } };
