...
// #pragma omp dummyFlush BARRIER_START written([u, _imopVarPre148, _imopVarPre147]) read()
#pragma omp barrier
...
// #pragma omp dummyFlush BARRIER_START written([_imopVarPre152, _imopVarPre151, w]) read()
#pragma omp barrier
        int p;
#pragma omp master
        {
...
// #pragma omp dummyFlush BARRIER_START written([mean, heapCell#1, heapCell#2]) read()
#pragma omp barrier
...
// #pragma omp dummyFlush BARRIER_START written() read()
#pragma omp barrier
// #pragma omp dummyFlush BARRIER_START written() read([mean, w, printf, i])
#pragma omp barrier
#pragma omp master
        {
...
// #pragma omp dummyFlush BARRIER_START written() read()
#pragma omp barrier
// #pragma omp dummyFlush BARRIER_START written() read([epsilon, heapCell#4, heapCell#1, heapCell#2, diff, w, u, printf, i, omp_get_wtime])
#pragma omp barrier
#pragma omp master
        {
            iterations = 0;
...
//                }
//            }
// #pragma omp dummyFlush BARRIER_START written([heapCell#3]) read([heapCell#3, heapCell#2, heapCell#1, w, u, i])
#pragma omp barrier
#pragma omp for nowait
            for (i = 1; i < 500 - 1; i++) {
                for (j = 1; j < 500 - 1; j++) {
tc11: w[i][j] = (u[i - 1][j] + u[i + 1][j] + u[i][j - 1] + u[i][j + 1]) / 4.0;
                }
            }
// #pragma omp dummyFlush BARRIER_START written([]) read([])
#pragma omp barrier
...
// #pragma omp dummyFlush BARRIER_START written([diff]) read([w, u, fabs, i])
#pragma omp barrier
            my_diff = 0.0;
#pragma omp for nowait
            for (i = 1; i < 500 - 1; i++) {
...
tc12: _imopVarPre167 = w[i][j] - u[i][j];
...
// #pragma omp dummyFlush BARRIER_START written([]) read([diff, iterations_print, printf, iterations])
#pragma omp barrier
#pragma omp master
            {
                iterations++;
...
// #pragma omp dummyFlush BARRIER_START written([iterations_print, iterations]) read([epsilon, diff, w, u, printf, i, omp_get_wtime])
#pragma omp barrier
        }
// #pragma omp dummyFlush BARRIER_START written([]) read([_imopVarPre173, diff, printf, iterations, omp_get_wtime, wtime])
#pragma omp barrier
#pragma omp master
        {
