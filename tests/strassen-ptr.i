     ...
     unsigned RowWidthC, unsigned RowWidthA, unsigned RowWidthB, int Depth)
{
  ...
  for (Row = 0; Row < QuadrantSize; Row++) {
    for (Column = 0; Column < QuadrantSize; Column++) {
      ...
      (* (REAL *) ( ((PTR) S2) + TempMatrixOffset ) ) = (* (REAL *) ( ((PTR) S1) + TempMatrixOffset ) ) - (* (REAL *) ( ((PTR) A) + MatrixOffsetA ) );
      (* (REAL *) ( ((PTR) S4) + TempMatrixOffset ) ) = (* (REAL *) ( ((PTR) A12) + MatrixOffsetA ) ) - (* (REAL *) ( ((PTR) S2) + TempMatrixOffset ) );
      (* (REAL *) ( ((PTR) S5) + TempMatrixOffset ) ) = (* (REAL *) ( ((PTR) B12) + MatrixOffsetB ) ) - (* (REAL *) ( ((PTR) B) + MatrixOffsetB ) );
