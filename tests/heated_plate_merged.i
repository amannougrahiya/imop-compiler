...
int main(int argc, char *argv[]) {
    ...
    double u[500][500];
    double w[500][500];
#pragma omp parallel shared(mean, diff)
    {
        double wtime;
...
#pragma omp master
        {
            _imopVarPre146 = omp_get_num_procs();
...
#pragma omp master
        {
            _imopVarPre148 = omp_get_max_threads();
            printf("  Number of threads =              %d\n", _imopVarPre148);
            mean = 0.0;
        }
        // #pragma omp dummyFlush BARRIER_START written([mean]) read()
#pragma omp barrier
...
#pragma omp for reduction(+:mean) nowait
        ...
        // #pragma omp dummyFlush BARRIER_START written() read()
#pragma omp barrier
        // #pragma omp dummyFlush BARRIER_START written() read([mean, printf, w, i, w.f])
#pragma omp barrier
#pragma omp master
        {
...
#pragma omp for nowait
        ...
        // #pragma omp dummyFlush BARRIER_START written() read()
#pragma omp barrier
        // #pragma omp dummyFlush BARRIER_START written() read([epsilon, omp_get_wtime, u, printf, w, u.f, i, w.f, diff])
#pragma omp barrier
#pragma omp master
        {
            iterations = 0;
...
#pragma omp for nowait
            ...
            // #pragma omp dummyFlush BARRIER_START written([u.f]) read([u, w, u.f, i, w.f])
#pragma omp barrier
#pragma omp for nowait
            for (i = 1; i < 500 - 1; i++) {
                for (j = 1; j < 500 - 1; j++) {
            ...
            // #pragma omp dummyFlush BARRIER_START written([w.f]) read([])
#pragma omp barrier
            // #pragma omp dummyFlush BARRIER_START written([]) read([])
#pragma omp barrier
#pragma omp master
            ...
            // #pragma omp dummyFlush BARRIER_START written([diff]) read([fabs, u, w, u.f, i, w.f])
#pragma omp barrier
            my_diff = 0.0;
#pragma omp for nowait
            for (i = 1; i < 500 - 1; i++) {
                for (j = 1; j < 500 - 1; j++) {
                    ...
                    _imopVarPre151 = w[i][j] - u[i][j];
                    _imopVarPre152 = fabs(_imopVarPre151);
                    if (my_diff < _imopVarPre152) {
                        double _imopVarPre154;
                        double _imopVarPre155;
                        _imopVarPre154 = w[i][j] - u[i][j];
                        _imopVarPre155 = fabs(_imopVarPre154);
                        my_diff = _imopVarPre155;
                    }
                }
            }
            // #pragma omp dummyFlush BARRIER_START written([]) read([])
...
#pragma omp critical
            ...
            // #pragma omp dummyFlush BARRIER_START written([]) read([printf, iterations, diff, iterations_print])
#pragma omp barrier
#pragma omp master
            {
                iterations++;
            ...
            // #pragma omp dummyFlush BARRIER_START written([iterations, iterations_print]) read([epsilon, omp_get_wtime, u, printf, w, u.f, i, w.f, diff])
#pragma omp barrier
        }
        // #pragma omp dummyFlush BARRIER_START written([]) read([omp_get_wtime, printf, wtime, iterations, diff, _imopVarPre157])
#pragma omp barrier
#pragma omp master
        {
            _imopVarPre157 = omp_get_wtime();
            wtime = _imopVarPre157 - wtime;
            printf("\n");
            printf("  %8d  %f\n", iterations, diff);
            printf("\n");
