        ...
        double X[1024 + 0][1024 + 0])
{
    ...
    for (i = 0; i < n; i++)
        for (j = 0; j < n; j++) {
            fprintf(__stderrp, "%0.2lf ", X[i][j]);
            if ((i * 1024 + j) % 20 == 0) fprintf(__stderrp, "\n");
        }
    fprintf(__stderrp, "\n");
}
    static
...
int main(int argc, char** argv)
{
    int n = 1024;
    int tsteps = 50;
    double (*X)[1024 + 0][1024 + 0]; X = (double(*)[1024 + 0][1024 + 0])polybench_alloc_data ((1024 + 0) * (1024 + 0), sizeof(double));;
