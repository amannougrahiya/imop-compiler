...
int main(int argc, char **argv) {
    ...
    firstcol = 1;
    lastcol = 75000;
    if (75000 == 1400 && 13 == 7 && 75 == 15 && 60.0 == 10.0) {
 class = 'S';
 zeta_verify_value = 8.5971775078648;
    } else if (75000 == 7000 && 13 == 8 && 75 == 15 && 60.0 == 12.0) {
 class = 'W';
 zeta_verify_value = 10.362595087124;
    } else if (75000 == 14000 && 13 == 11 && 75 == 15 && 60.0 == 20.0) {
 class = 'A';
 zeta_verify_value = 17.130235054029;
    } else if (75000 == 75000 && 13 == 13 && 75 == 75 && 60.0 == 60.0) {
 class = 'B';
 zeta_verify_value = 22.712745482631;
    } else if (75000 == 150000 && 13 == 15 && 75 == 75 && 60.0 == 110.0) {
 class = 'C';
 ...
 class = 'U';
    ...
    makea(naa, nzz, a, colidx, rowstr, 13,
   firstrow, lastrow, firstcol, lastcol,
   1.0e-1, arow, acol, aelt, v, iv, 60.0);
...
#pragma omp master
 ...
 printf(" NO VERIFICATION PERFORMED\n");
    ...
    if ( t != 0.0 ) {
 mflops = (2.0*75*75000)
     * (3.0+(13*(13 +1)) + 25.0*(5.0+(13*(13 +1))) + 3.0 )
     / t / 1000000.0;
    } else {
 mflops = 0.0;
    }
    c_print_results("CG", class, 75000, 0, 0, 75, nthreads, t,
