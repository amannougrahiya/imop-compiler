...
static double dssp;
static double u[102][102/2*2+1][102/2*2+1][5];
static double rsd[102][102/2*2+1][102/2*2+1][5];
static double frct[102][102/2*2+1][102/2*2+1][5];
static double flux[102][102/2*2+1][102/2*2+1][5];
static int ipr, inorm;
static int itmax, invert;
static double dt, omega, tolrsd[5], rsdnm[5], errnm[5], frc, ttotal;
static double a[102][102][5][5];
static double b[102][102][5][5];
static double c[102][102][5][5];
static double d[102][102][5][5];
static double ce[5][13];
static double maxtime;
static boolean flag[102/2*2+1];
static void blts (int nx, int ny, int nz, int k,
    double omega,
    double v[102][102/2*2+1][102/2*2+1][5],
    double ldz[102][102][5][5],
    double ldy[102][102][5][5],
    double ldx[102][102][5][5],
    double d[102][102][5][5],
...
static void buts(int nx, int ny, int nz, int k,
   ...
   double tv[102][102][5],
   double d[102][102][5][5],
   double udx[102][102][5][5],
   double udy[102][102][5][5],
   double udz[102][102][5][5],
   int ist, int iend, int jst, int jend,
   int nx0, int ny0 );
...
#pragma omp master
  ...
  c_print_results("LU", class, nx0,
    ...
    "3.0 structured", "01 Dec 2019", "kinst-ompp gcc", "kinst-ompp gcc", "-lm", "-I../common", "-O3 -fopenmp", "-O3 -fopenmp -fPIC",
    "(none)");
}
static void blts (int nx, int ny, int nz, int k,
    double omega,
...
static void pintgr(void) {
  ...
  double phi1[102 +2][102 +2];
  double phi2[102 +2][102 +2];
