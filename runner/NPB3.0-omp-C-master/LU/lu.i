...
static void blts (int nx, int ny, int nz, int k,
    ...
    double ldz[12][12][5][5],
    double ldy[12][12][5][5],
    double ldx[12][12][5][5],
    double d[12][12][5][5],
...
static void buts(int nx, int ny, int nz, int k,
   ...
   double tv[12][12][5],
   double d[12][12][5][5],
   double udx[12][12][5][5],
   double udy[12][12][5][5],
   double udz[12][12][5][5],
   int ist, int iend, int jst, int jend,
   int nx0, int ny0 );
...
#pragma omp master
  ...
  c_print_results("LU", class, nx0,
    ...
    "3.0 structured", "21 Jul 2017", "gcc", "gcc", "(none)", "-I../common", "-O3 -fopenmp", "-O3 -fopenmp",
    "(none)");
}
static void blts (int nx, int ny, int nz, int k,
    double omega,
