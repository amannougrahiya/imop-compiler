...
extern __inline int __sputc(int _c, FILE *_p) {
    signed int _imopVar106;
    signed int _imopVar110;
    _imopVar106 = --_p->_w >= 0;
    if (!_imopVar106) {
        _imopVar110 = _p->_w >= _p->_lbfsize;
        if (_imopVar110) {
            _imopVar110 = (char) _c != '\n';
        }
        _imopVar106 = _imopVar110;
    }
    if (_imopVar106) {
        return (*_p->_p++ = _c);
    } else {
        signed int _imopVar112;
        signed int _imopVar75;
        _imopVar75 = __swbuf(_c, _p);
        _imopVar112 = _imopVar75;
        return _imopVar112;
    }
}
void flockfile(FILE *);
...
extern __inline int __inline_isfinitef(float __x) {
    signed int _imopVar116;
    float _imopVar117;
    float _imopVar118;
    _imopVar116 = __x == __x;
    if (_imopVar116) {
        float _imopVar76;
        _imopVar76 = __builtin_fabsf(__x);
        _imopVar117 = _imopVar76;
        float _imopVar77;
        _imopVar77 = __builtin_inff();
        _imopVar118 = _imopVar77;
        _imopVar116 = _imopVar117 != _imopVar118;
    }
    return _imopVar116;
}
extern __inline int __inline_isfinited(double __x) {
    signed int _imopVar122;
    double _imopVar123;
    double _imopVar124;
    _imopVar122 = __x == __x;
    if (_imopVar122) {
        double _imopVar78;
        _imopVar78 = __builtin_fabs(__x);
        _imopVar123 = _imopVar78;
        double _imopVar79;
        _imopVar79 = __builtin_inf();
        _imopVar124 = _imopVar79;
        _imopVar122 = _imopVar123 != _imopVar124;
    }
    return _imopVar122;
}
extern __inline int __inline_isfinitel(long double __x) {
    signed int _imopVar128;
    long double _imopVar129;
    long double _imopVar130;
    _imopVar128 = __x == __x;
    if (_imopVar128) {
        long double _imopVar80;
        _imopVar80 = __builtin_fabsl(__x);
        _imopVar129 = _imopVar80;
        long double _imopVar81;
        _imopVar81 = __builtin_infl();
        _imopVar130 = _imopVar81;
        _imopVar128 = _imopVar129 != _imopVar130;
    }
    return _imopVar128;
}
extern __inline int __inline_isinff(float __x) {
    ...
    float _imopVar134;
    float _imopVar82;
    _imopVar82 = __builtin_fabsf(__x);
    _imopVar133 = _imopVar82;
    float _imopVar83;
    _imopVar83 = __builtin_inff();
    _imopVar134 = _imopVar83;
    return _imopVar133 == _imopVar134;
}
extern __inline int __inline_isinfd(double __x) {
    double _imopVar137;
    double _imopVar138;
    double _imopVar84;
    _imopVar84 = __builtin_fabs(__x);
    _imopVar137 = _imopVar84;
    double _imopVar85;
    _imopVar85 = __builtin_inf();
    _imopVar138 = _imopVar85;
    return _imopVar137 == _imopVar138;
}
extern __inline int __inline_isinfl(long double __x) {
    long double _imopVar141;
    long double _imopVar142;
    long double _imopVar86;
    _imopVar86 = __builtin_fabsl(__x);
    _imopVar141 = _imopVar86;
    long double _imopVar87;
    _imopVar87 = __builtin_infl();
    _imopVar142 = _imopVar87;
    return _imopVar141 == _imopVar142;
}
...
extern __inline int __inline_signbitl(long double __x) {
    union stUn_imopVar85 {
        long double __ld;
        struct stUn_imopVar84 {
...
extern __inline int __inline_isnormalf(float __x) {
    signed int _imopVar145;
    float _imopVar146;
    signed int _imopVar88;
    _imopVar88 = __inline_isfinitef(__x);
    _imopVar145 = _imopVar88;
    if (_imopVar145) {
        float _imopVar89;
        _imopVar89 = __builtin_fabsf(__x);
        _imopVar146 = _imopVar89;
        _imopVar145 = _imopVar146 >= 1.17549435082228750797e-38F;
    }
    return _imopVar145;
}
extern __inline int __inline_isnormald(double __x) {
    signed int _imopVar149;
    double _imopVar150;
    signed int _imopVar90;
    _imopVar90 = __inline_isfinited(__x);
    _imopVar149 = _imopVar90;
    if (_imopVar149) {
        double _imopVar91;
        _imopVar91 = __builtin_fabs(__x);
        _imopVar150 = _imopVar91;
        _imopVar149 = _imopVar150 >= ((double) 2.22507385850720138309e-308L);
    }
    return _imopVar149;
}
extern __inline int __inline_isnormall(long double __x) {
    signed int _imopVar153;
    long double _imopVar154;
    signed int _imopVar92;
    _imopVar92 = __inline_isfinitel(__x);
    _imopVar153 = _imopVar92;
    if (_imopVar153) {
        long double _imopVar93;
        _imopVar93 = __builtin_fabsl(__x);
        _imopVar154 = _imopVar93;
        _imopVar153 = _imopVar154 >= 3.36210314311209350626e-4932L;
    }
    return _imopVar153;
}
...
int main(int argc, char **argv) {
    ...
    struct __sFILE *_imopVar159;
    struct __sFILE *_imopVar98;
    _imopVar98 = fopen("inputbt.data", "r");
    _imopVar159 = _imopVar98;
    fp = _imopVar159;
    if (fp != ((void *) 0)) {
        printf(" Reading from input file inputbt.data");
        signed int *_imopVar161;
        _imopVar161 = &niter;
        fscanf(fp, "%d", _imopVar161);
        signed int _imopVar163;
        signed int _imopVar99;
        _imopVar99 = fgetc(fp);
        _imopVar163 = _imopVar99;
        while (_imopVar163 != '\n') {
            ;
            signed int _imopVar100;
            _imopVar100 = fgetc(fp);
            _imopVar163 = _imopVar100;
        }
        double *_imopVar165;
        _imopVar165 = &dt;
        fscanf(fp, "%lg", _imopVar165);
        signed int _imopVar167;
        signed int _imopVar101;
        _imopVar101 = fgetc(fp);
        _imopVar167 = _imopVar101;
        while (_imopVar167 != '\n') {
            ;
            signed int _imopVar102;
            _imopVar102 = fgetc(fp);
            _imopVar167 = _imopVar102;
        }
        signed int *_imopVar171;
        signed int *_imopVar172;
        signed int *_imopVar173;
        _imopVar171 = &grid_points[2];
        _imopVar172 = &grid_points[1];
        _imopVar173 = &grid_points[0];
        fscanf(fp, "%d%d%d", _imopVar173, _imopVar172, _imopVar171);
        fclose(fp);
    } else {
    ...
    signed int _imopVar177;
    signed int _imopVar178;
    signed int _imopVar179;
    _imopVar177 = grid_points[2];
    _imopVar178 = grid_points[1];
    _imopVar179 = grid_points[0];
    printf(" Size: %3dx%3dx%3d\n", _imopVar179, _imopVar178, _imopVar177);
    printf(" Iterations: %3d   dt: %10.6f\n", niter, dt);
    signed int _imopVar180;
    signed int _imopVar181;
    _imopVar180 = grid_points[0] > 12;
    if (!_imopVar180) {
        _imopVar181 = grid_points[1] > 12;
        if (!_imopVar181) {
            _imopVar181 = grid_points[2] > 12;
        }
        _imopVar180 = _imopVar181;
    }
    if (_imopVar180) {
        signed int _imopVar185;
        signed int _imopVar186;
        signed int _imopVar187;
        _imopVar185 = grid_points[2];
        _imopVar186 = grid_points[1];
        _imopVar187 = grid_points[0];
        printf(" %dx%dx%d\n", _imopVar187, _imopVar186, _imopVar185);
    ...
    for (step = 1; step <= niter; step++) {
        signed int _imopVar188;
        _imopVar188 = step % 20 == 0;
        if (!_imopVar188) {
            _imopVar188 = step == 1;
        }
        if (_imopVar188) {
...
#pragma omp parallel
    ...
    double _imopVar189;
    double _imopVar103;
    _imopVar103 = timer_read(1);
    _imopVar189 = _imopVar103;
    tmax = _imopVar189;
    signed int *_imopVar192;
    char *_imopVar193;
    _imopVar192 = &verified;
    _imopVar193 = &class;
    verify(niter, _imopVar193, _imopVar192);
    ...
    signed int _imopVar197;
    signed int _imopVar198;
    signed int _imopVar199;
    _imopVar197 = grid_points[2];
    _imopVar198 = grid_points[1];
    _imopVar199 = grid_points[0];
    c_print_results("BT", class, _imopVar199, _imopVar198, _imopVar197, niter, nthreads, tmax, mflops, "          floating point", verified, "3.0 structured", "15 Jul 2017", "gcc", "gcc", "(none)", "-I../common", "-O3 -fopenmp", "-O3 -fopenmp", "(none)");
}
static void add(void ) {
    int i;
    int j;
...
static void error_norm(double rms[5]) {
    ...
    for (m = 0; m < 5; m++) {
        ...
        _imopVar201 = rms[m];
        double _imopVar105;
        _imopVar105 = sqrt(_imopVar201);
        _imopVar202 = _imopVar105;
        rms[m] = _imopVar202;
    }
}
static void rhs_norm(double rms[5]) {
    ...
    for (m = 0; m < 5; m++) {
        ...
        _imopVar204 = rms[m];
        double _imopVar106;
        _imopVar106 = sqrt(_imopVar204);
        _imopVar205 = _imopVar106;
        rms[m] = _imopVar205;
    }
}
static void exact_rhs(void ) {
            ...
            for (j = 0; j < grid_points[1]; j++) {
                ...
                for (k = 0; k < grid_points[2]; k++) {
                    ...
                    for (ix = 0; ix < 2; ix++) {
                        double *_imopVar208;
                        double _imopVar209;
                        _imopVar208 = &(Pface[ix][0][0]);
                        _imopVar209 = (double) ix;
                        exact_solution(_imopVar209, eta, zeta, _imopVar208);
                    }
                    for (iy = 0; iy < 2; iy++) {
                        double *_imopVar212;
                        double _imopVar213;
                        _imopVar212 = &Pface[iy][1][0];
                        _imopVar213 = (double) iy;
                        exact_solution(xi, _imopVar213, zeta, _imopVar212);
                    }
                    for (iz = 0; iz < 2; iz++) {
                        double *_imopVar216;
                        double _imopVar217;
                        _imopVar216 = &Pface[iz][2][0];
                        _imopVar217 = (double) iz;
                        exact_solution(xi, eta, _imopVar217, _imopVar216);
                    }
                    for (m = 0; m < 5; m++) {
...
static void set_constants(void ) {
    ...
    dzmax = _imopVar229;
    signed int _imopVar270;
    double _imopVar271;
    signed int _imopVar272;
    double _imopVar273;
    signed int _imopVar280;
    double _imopVar281;
    _imopVar270 = (dy1 > dz1);
    if (_imopVar270) {
        _imopVar271 = dy1;
    ...
    if (_imopVar272) {
        ...
        _imopVar273 = _imopVar281;
    }
    dssp = 0.25 * _imopVar273;
    c4dssp = 4.0 * dssp;
    c5dssp = 5.0 * dssp;
    dttx1 = dt * tx1;
    dttx2 = dt * tx2;
...
static void verify(int no_time_steps, char *class , boolean *verified) {
    ...
    *verified = 1;
    ...
    signed int _imopVar285;
    signed int _imopVar286;
    signed int _imopVar287;
    _imopVar285 = grid_points[0] == 12;
    if (_imopVar285) {
        _imopVar286 = grid_points[1] == 12;
        if (_imopVar286) {
            _imopVar287 = grid_points[2] == 12;
            if (_imopVar287) {
                _imopVar287 = no_time_steps == 60;
            }
            _imopVar286 = _imopVar287;
        }
        _imopVar285 = _imopVar286;
    }
    if (_imopVar285) {
        *class = 'S';
        dtref = 1.0e-2;
        ...
        signed int _imopVar291;
        signed int _imopVar292;
        signed int _imopVar293;
        _imopVar291 = grid_points[0] == 24;
        if (_imopVar291) {
            _imopVar292 = grid_points[1] == 24;
            if (_imopVar292) {
                _imopVar293 = grid_points[2] == 24;
                if (_imopVar293) {
                    _imopVar293 = no_time_steps == 200;
                }
                _imopVar292 = _imopVar293;
            }
            _imopVar291 = _imopVar292;
        }
        if (_imopVar291) {
            *class = 'W';
            dtref = 0.8e-3;
            ...
            signed int _imopVar297;
            signed int _imopVar298;
            signed int _imopVar299;
            _imopVar297 = grid_points[0] == 64;
            if (_imopVar297) {
                _imopVar298 = grid_points[1] == 64;
                if (_imopVar298) {
                    _imopVar299 = grid_points[2] == 64;
                    if (_imopVar299) {
                        _imopVar299 = no_time_steps == 200;
                    }
                    _imopVar298 = _imopVar299;
                }
                _imopVar297 = _imopVar298;
            }
            if (_imopVar297) {
                *class = 'A';
                dtref = 0.8e-3;
                ...
                signed int _imopVar303;
                signed int _imopVar304;
                signed int _imopVar305;
                _imopVar303 = grid_points[0] == 102;
                if (_imopVar303) {
                    _imopVar304 = grid_points[1] == 102;
                    if (_imopVar304) {
                        _imopVar305 = grid_points[2] == 102;
                        if (_imopVar305) {
                            _imopVar305 = no_time_steps == 200;
                        }
                        _imopVar304 = _imopVar305;
                    }
                    _imopVar303 = _imopVar304;
                }
                if (_imopVar303) {
                    *class = 'B';
                    dtref = 3.0e-4;
                    ...
                    signed int _imopVar309;
                    signed int _imopVar310;
                    signed int _imopVar311;
                    _imopVar309 = grid_points[0] == 162;
                    if (_imopVar309) {
                        _imopVar310 = grid_points[1] == 162;
                        if (_imopVar310) {
                            _imopVar311 = grid_points[2] == 162;
                            if (_imopVar311) {
                                _imopVar311 = no_time_steps == 200;
                            }
                            _imopVar310 = _imopVar311;
                        }
                        _imopVar309 = _imopVar310;
                    }
                    if (_imopVar309) {
                        *class = 'C';
                        dtref = 1.0e-4;
    ...
    for (m = 0; m < 5; m++) {
        double _imopVar313;
        double _imopVar314;
        _imopVar313 = (xcr[m] - xcrref[m]) / xcrref[m];
        double _imopVar115;
        _imopVar115 = fabs(_imopVar313);
        _imopVar314 = _imopVar115;
        xcrdif[m] = _imopVar314;
        double _imopVar316;
        double _imopVar317;
        _imopVar316 = (xce[m] - xceref[m]) / xceref[m];
        double _imopVar116;
        _imopVar116 = fabs(_imopVar316);
        _imopVar317 = _imopVar116;
        xcedif[m] = _imopVar317;
    }
    if (*class != 'U') {
        char _imopVar319;
        _imopVar319 = *class;
        ...
        double _imopVar322;
        double _imopVar323;
        _imopVar322 = dt - dtref;
        double _imopVar117;
        _imopVar117 = fabs(_imopVar322);
        _imopVar323 = _imopVar117;
        if (_imopVar323 > epsilon) {
            *verified = 0;
            *class = 'U';
        ...
        if (*class == 'U') {
            ...
            if (xcrdif[m] > epsilon) {
                *verified = 0;
                ...
                double _imopVar330;
                double _imopVar331;
                _imopVar329 = xcrdif[m];
                _imopVar330 = xcrref[m];
                _imopVar331 = xcr[m];
                printf(" FAILURE: %2d%20.13e%20.13e%20.13e\n", m, _imopVar331, _imopVar330, _imopVar329);
            } else {
                double _imopVar335;
                double _imopVar336;
                double _imopVar337;
                _imopVar335 = xcrdif[m];
                _imopVar336 = xcrref[m];
                _imopVar337 = xcr[m];
                printf("          %2d%20.13e%20.13e%20.13e\n", m, _imopVar337, _imopVar336, _imopVar335);
            }
        }
    }
    if (*class != 'U') {
        ...
        if (*class == 'U') {
            ...
            if (xcedif[m] > epsilon) {
                *verified = 0;
                ...
                double _imopVar344;
                double _imopVar345;
                _imopVar343 = xcedif[m];
                _imopVar344 = xceref[m];
                _imopVar345 = xce[m];
                printf(" FAILURE: %2d%20.13e%20.13e%20.13e\n", m, _imopVar345, _imopVar344, _imopVar343);
            } else {
                double _imopVar349;
                double _imopVar350;
                double _imopVar351;
                _imopVar349 = xcedif[m];
                _imopVar350 = xceref[m];
                _imopVar351 = xce[m];
                printf("          %2d%20.13e%20.13e%20.13e\n", m, _imopVar351, _imopVar350, _imopVar349);
            }
        }
    }
    if (*class == 'U') {
...
#pragma omp for nowait
    for (j = 1; j < grid_points[1] - 1; j++) {
        for (k = 1; k < grid_points[2] - 1; k++) {
            double *_imopVar355;
            double ( *_imopVar356 )[5];
            double ( *_imopVar357 )[5];
            _imopVar355 = rhs[0][j][k];
            _imopVar356 = lhs[0][j][k][2];
            _imopVar357 = lhs[0][j][k][1];
            binvcrhs(_imopVar357, _imopVar356, _imopVar355);
        }
    }
...
#pragma omp for nowait
        for (j = 1; j < grid_points[1] - 1; j++) {
            for (k = 1; k < grid_points[2] - 1; k++) {
                double *_imopVar361;
                double *_imopVar362;
                double ( *_imopVar363 )[5];
                _imopVar361 = rhs[i][j][k];
                _imopVar362 = rhs[i - 1][j][k];
                _imopVar363 = lhs[i][j][k][0];
                matvec_sub(_imopVar363, _imopVar362, _imopVar361);
                double ( *_imopVar367 )[5];
                double ( *_imopVar368 )[5];
                double ( *_imopVar369 )[5];
                _imopVar367 = lhs[i][j][k][1];
                _imopVar368 = lhs[i - 1][j][k][2];
                _imopVar369 = lhs[i][j][k][0];
                matmul_sub(_imopVar369, _imopVar368, _imopVar367);
                double *_imopVar373;
                double ( *_imopVar374 )[5];
                double ( *_imopVar375 )[5];
                _imopVar373 = rhs[i][j][k];
                _imopVar374 = lhs[i][j][k][2];
                _imopVar375 = lhs[i][j][k][1];
                binvcrhs(_imopVar375, _imopVar374, _imopVar373);
            }
        }
...
#pragma omp for nowait
    for (j = 1; j < grid_points[1] - 1; j++) {
        for (k = 1; k < grid_points[2] - 1; k++) {
            double *_imopVar379;
            double *_imopVar380;
            double ( *_imopVar381 )[5];
            _imopVar379 = rhs[isize][j][k];
            _imopVar380 = rhs[isize - 1][j][k];
            _imopVar381 = lhs[isize][j][k][0];
            matvec_sub(_imopVar381, _imopVar380, _imopVar379);
            double ( *_imopVar385 )[5];
            double ( *_imopVar386 )[5];
            double ( *_imopVar387 )[5];
            _imopVar385 = lhs[isize][j][k][1];
            _imopVar386 = lhs[isize - 1][j][k][2];
            _imopVar387 = lhs[isize][j][k][0];
            matmul_sub(_imopVar387, _imopVar386, _imopVar385);
            double *_imopVar390;
            double ( *_imopVar391 )[5];
            _imopVar390 = rhs[i][j][k];
            _imopVar391 = lhs[i][j][k][1];
            binvrhs(_imopVar391, _imopVar390);
        }
    }
...
#pragma omp for nowait
    for (i = 1; i < grid_points[0] - 1; i++) {
        for (k = 1; k < grid_points[2] - 1; k++) {
            double *_imopVar395;
            double ( *_imopVar396 )[5];
            double ( *_imopVar397 )[5];
            _imopVar395 = rhs[i][0][k];
            _imopVar396 = lhs[i][0][k][2];
            _imopVar397 = lhs[i][0][k][1];
            binvcrhs(_imopVar397, _imopVar396, _imopVar395);
        }
    }
...
#pragma omp for nowait
        for (i = 1; i < grid_points[0] - 1; i++) {
            for (k = 1; k < grid_points[2] - 1; k++) {
                double *_imopVar401;
                double *_imopVar402;
                double ( *_imopVar403 )[5];
                _imopVar401 = rhs[i][j][k];
                _imopVar402 = rhs[i][j - 1][k];
                _imopVar403 = lhs[i][j][k][0];
                matvec_sub(_imopVar403, _imopVar402, _imopVar401);
                double ( *_imopVar407 )[5];
                double ( *_imopVar408 )[5];
                double ( *_imopVar409 )[5];
                _imopVar407 = lhs[i][j][k][1];
                _imopVar408 = lhs[i][j - 1][k][2];
                _imopVar409 = lhs[i][j][k][0];
                matmul_sub(_imopVar409, _imopVar408, _imopVar407);
                double *_imopVar413;
                double ( *_imopVar414 )[5];
                double ( *_imopVar415 )[5];
                _imopVar413 = rhs[i][j][k];
                _imopVar414 = lhs[i][j][k][2];
                _imopVar415 = lhs[i][j][k][1];
                binvcrhs(_imopVar415, _imopVar414, _imopVar413);
            }
        }
...
#pragma omp for nowait
    for (i = 1; i < grid_points[0] - 1; i++) {
        for (k = 1; k < grid_points[2] - 1; k++) {
            double *_imopVar419;
            double *_imopVar420;
            double ( *_imopVar421 )[5];
            _imopVar419 = rhs[i][jsize][k];
            _imopVar420 = rhs[i][jsize - 1][k];
            _imopVar421 = lhs[i][jsize][k][0];
            matvec_sub(_imopVar421, _imopVar420, _imopVar419);
            double ( *_imopVar425 )[5];
            double ( *_imopVar426 )[5];
            double ( *_imopVar427 )[5];
            _imopVar425 = lhs[i][jsize][k][1];
            _imopVar426 = lhs[i][jsize - 1][k][2];
            _imopVar427 = lhs[i][jsize][k][0];
            matmul_sub(_imopVar427, _imopVar426, _imopVar425);
            double *_imopVar430;
            double ( *_imopVar431 )[5];
            _imopVar430 = rhs[i][jsize][k];
            _imopVar431 = lhs[i][jsize][k][1];
            binvrhs(_imopVar431, _imopVar430);
        }
    }
...
#pragma omp for nowait
    for (i = 1; i < grid_points[0] - 1; i++) {
        for (j = 1; j < grid_points[1] - 1; j++) {
            double *_imopVar435;
            double ( *_imopVar436 )[5];
            double ( *_imopVar437 )[5];
            _imopVar435 = rhs[i][j][0];
            _imopVar436 = lhs[i][j][0][2];
            _imopVar437 = lhs[i][j][0][1];
            binvcrhs(_imopVar437, _imopVar436, _imopVar435);
        }
    }
...
#pragma omp for nowait
        for (i = 1; i < grid_points[0] - 1; i++) {
            for (j = 1; j < grid_points[1] - 1; j++) {
                double *_imopVar441;
                double *_imopVar442;
                double ( *_imopVar443 )[5];
                _imopVar441 = rhs[i][j][k];
                _imopVar442 = rhs[i][j][k - 1];
                _imopVar443 = lhs[i][j][k][0];
                matvec_sub(_imopVar443, _imopVar442, _imopVar441);
                double ( *_imopVar447 )[5];
                double ( *_imopVar448 )[5];
                double ( *_imopVar449 )[5];
                _imopVar447 = lhs[i][j][k][1];
                _imopVar448 = lhs[i][j][k - 1][2];
                _imopVar449 = lhs[i][j][k][0];
                matmul_sub(_imopVar449, _imopVar448, _imopVar447);
                double *_imopVar453;
                double ( *_imopVar454 )[5];
                double ( *_imopVar455 )[5];
                _imopVar453 = rhs[i][j][k];
                _imopVar454 = lhs[i][j][k][2];
                _imopVar455 = lhs[i][j][k][1];
                binvcrhs(_imopVar455, _imopVar454, _imopVar453);
            }
        }
...
#pragma omp for nowait
    for (i = 1; i < grid_points[0] - 1; i++) {
        for (j = 1; j < grid_points[1] - 1; j++) {
            double *_imopVar459;
            double *_imopVar460;
            double ( *_imopVar461 )[5];
            _imopVar459 = rhs[i][j][ksize];
            _imopVar460 = rhs[i][j][ksize - 1];
            _imopVar461 = lhs[i][j][ksize][0];
            matvec_sub(_imopVar461, _imopVar460, _imopVar459);
            double ( *_imopVar465 )[5];
            double ( *_imopVar466 )[5];
            double ( *_imopVar467 )[5];
            _imopVar465 = lhs[i][j][ksize][1];
            _imopVar466 = lhs[i][j][ksize - 1][2];
            _imopVar467 = lhs[i][j][ksize][0];
            matmul_sub(_imopVar467, _imopVar466, _imopVar465);
            double *_imopVar470;
            double ( *_imopVar471 )[5];
            _imopVar470 = rhs[i][j][ksize];
            _imopVar471 = lhs[i][j][ksize][1];
            binvrhs(_imopVar471, _imopVar470);
        }
    }
