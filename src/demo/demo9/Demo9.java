...
public class Demo9 {
     ...
     * TODO OPTIONS:
     *  1. reads1.overlapsWith(writes2) || reads2.overlapsWith(writes1) || writes1.overlapsWith(writes2)
     *  2. ph.getBeginPoints()
     *  3. allPhaseSet.addAll((Collection<? extends Phase>) parConsNode.getInfo().getConnectedPhases());
     */
