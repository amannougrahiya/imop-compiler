...
public class Demo6 {
     ...
     *      2. Statement newWhileStmt = FrontEnd.parseAndNormalize(newWhile, Statement.class);
     ...
     *      5. String whilePredicate = whileStmt.getInfo().getCFGInfo().getPredicate().toString();
     *      6. String newWhile = "while (" + whilePredicate + ") { " + whileBody + " if (! (" + whilePredicate + ")) {break;}" + whileBody + "}";
     */
     ...
     *      2. Statement whileStmt = FrontEnd.parseAndNormalize(whileString, Statement.class);
     *      3. String doPredicate = doStmt.getInfo().getCFGInfo().getPredicate().toString();
     *      4. String whileString = "{" + doBody + "while (" + doPredicate + ") " + doBody + "}";
