...
public class Deprecated_LoopTransformations {
	...
	//				originalUpdateExpressionString = originalUpdateExpression.getNode().getInfo().getString() + " ";
	//			} else {
	//				originalUpdateExpressionString = "";
	//			}
	//
	//			if (originalTerminationCheck.present()) {
	//				originalTerminationCheckString = originalTerminationCheck.getNode().getInfo().getString() + " ";
	//			} else {
	//				originalTerminationCheckString = "";
	//			}
	//
	//			String newBodyString = "{" + currentBody.getInfo().getString() + " " + originalUpdateExpressionString
	//					+ "; if (" + originalTerminationCheckString + ")" + originalBody.getInfo().getString()
	//					+ " else {break;}" + "}";
	 ...
	 * @param unrollFactor
	 *            the unrolling factor. Note that the unrolling factor of a loop
