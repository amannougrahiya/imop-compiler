...
public class Deprecated_SharedLvalueAccessGetter extends GJNoArguDepthFirstProcess<List<Cell>> {
	...
	//		if (sym != null) {
	//			for (Cell s : sym) {
	//				if (s != null && n.getInfo().getSharingAttribute(s) == DataSharingAttribute.SHARED) {
	...
	//	 */
	//	public Set<Cell> getPointsToClosure(List<Cell> pointerSet, List<Node> nodeSet) {
	...
	//			if (sym == null) {
	//				System.out.println(
	//						"Some problem with symbol table updates! Exiting from LvalueAccessGetter::InitDeclarator");
	//				System.exit(0);
	//			}
	//			sharedLvalueWriteList.add(sym);
	//			addReads(((NodeSequence) n.getF1().getNode()).getNodes().get(1).accept(this), n);
	//		}
	//		return null;
	//	}
	//
	...
	//		if (sym == null) {
	//			System.out.println(
	//					"Some problem with symbol table updates! Exiting from LvalueAccessGetter::OmpForInitExpression");
	//			System.exit(0);
	//		}
	//		sharedLvalueWriteList.add(sym);
	...
	//		if (sym == null) {
	//			System.out.println(
	//					"Some problem with symbol table updates! Exiting from LvalueAccessGetter::PostIncrementId");
	//			System.exit(0);
	//		}
	//		sharedLvalueReadList.add(sym);
	//		sharedLvalueWriteList.add(sym);
	...
	//		if (sym == null) {
	//			System.out.println(
	//					"Some problem with symbol table updates! Exiting from LvalueAccessGetter::PostDecrementId");
	//			System.exit(0);
	//		}
	//		sharedLvalueReadList.add(sym);
	//		sharedLvalueWriteList.add(sym);
	...
	//		if (sym == null) {
	//			System.out
	//					.println("Some problem with symbol table updates! Exiting from LvalueAccessGetter::PreIncrementId");
	//			System.exit(0);
	//		}
	//		sharedLvalueReadList.add(sym);
	//		sharedLvalueWriteList.add(sym);
	...
	//		if (sym == null) {
	//			System.out
	//					.println("Some problem with symbol table updates! Exiting from LvalueAccessGetter::PreDecrementId");
	//			System.exit(0);
	//		}
	//		sharedLvalueReadList.add(sym);
	//		sharedLvalueWriteList.add(sym);
	...
	//		if (sym == null) {
	//			System.out.println(
	//					"Some problem with symbol table updates! Exiting from LvalueAccessGetter::ShortAssignPlus");
	//			System.exit(0);
	//		}
	//		sharedLvalueReadList.add(sym);
	//		sharedLvalueWriteList.add(sym);
	...
	//		if (sym == null) {
	//			System.out.println(
	//					"Some problem with symbol table updates! Exiting from LvalueAccessGetter::ShortAssignMinus");
	//			System.exit(0);
	//		}
	//		sharedLvalueReadList.add(sym);
	//		sharedLvalueWriteList.add(sym);
	...
	//		if (sym == null) {
	//			System.out.println(
	//					"Some problem with symbol table updates! Exiting from LvalueAccessGetter::OmpForAdditive (1)");
	//			System.exit(0);
	//		}
	//		sharedLvalueWriteList.add(sym);
	...
	//		if (sym == null) {
	//			System.out.println(
	//					"Some problem with symbol table updates! Exiting from LvalueAccessGetter::OmpForAdditive (2)");
	//			System.exit(0);
	//		}
	//		sharedLvalueReadList.add(sym);
	...
	//		if (sym == null) {
	//			System.out.println(
	//					"Some problem with symbol table updates! Exiting from LvalueAccessGetter::OmpForSubtractive (1)");
	//			System.exit(0);
	//		}
	//		sharedLvalueWriteList.add(sym);
	//		sym = Misc.getSymbolEntry(n.getF2().getTokenImage(), n);
	//		if (sym == null) {
	//			System.out.println(
	//					"Some problem with symbol table updates! Exiting from LvalueAccessGetter::OmpForSubtractive (2)");
	//			System.exit(0);
	//		}
	//		sharedLvalueReadList.add(sym);
	//		addReads(n.getF4().accept(this), n);
	...
	//		if (sym == null) {
	//			System.out.println(
	//					"Some problem with symbol table updates! Exiting from LvalueAccessGetter::OmpForMultiplicative (1)");
	//			System.exit(0);
	//		}
	//		sharedLvalueWriteList.add(sym);
	...
	//		if (sym == null) {
	//			System.out.println(
	//					"Some problem with symbol table updates! Exiting from LvalueAccessGetter::OmpForMultiplicative (2)");
	//			System.exit(0);
	//		}
	//		sharedLvalueReadList.add(sym);
	//		addReads(n.getF2().accept(this), n);
	...
	//			Cell sym = Misc.getSymbolEntry(((NodeToken) n.getF0().getChoice()).getTokenImage(), n);
	//			if (sym != null) {
	//				_ret.add(sym);
	//			}
	//			return _ret;
