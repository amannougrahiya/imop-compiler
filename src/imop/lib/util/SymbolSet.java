...
public class SymbolSet extends SymbolCollection {
	...
	//				return true;
	//			} else {
	//				return ((Set<Symbol>) internalRepresentation).removeAll(c.internalRepresentation);
	//			}
	//		}
	//	}
	//
	...
	//				return true;
	//			} else {
	//				return ((Set<Symbol>) internalRepresentation).containsAll(c.internalRepresentation);
	//			}
	//		}
	//	}
	//
	...
	//				return true;
	//			} else {
	//				return ((Set<Symbol>) internalRepresentation).retainAll(c.internalRepresentation);
	//			}
	//		}
	//	}
	//
