...
public class SymbolList extends SymbolCollection {
	...
	//		if (((List<Symbol>) internalRepresentation).contains(Symbol.getGenericCell())) {
	//			Thread.dumpStack();
	//			Misc.warnDueToLackOfFeature("Trying to fetch from a universal SymbolList.", Main.root);
	...
	//		if (s == null) {
	//			Thread.dumpStack();
	//			Misc.warnDueToLackOfFeature("Cannot add a null symbol to a SymbolList.", Main.root);
	//			return false;
	//		}
	...
	//				return true;
	//			} else {
	//				return ((List<Symbol>) internalRepresentation).removeAll(c.internalRepresentation);
	//			}
	//		}
	//	}
	//
	...
	//				return true;
	//			} else {
	//				return ((List<Symbol>) internalRepresentation).containsAll(c.internalRepresentation);
	//			}
	//		}
	//	}
	//
	...
	//				return true;
	//			} else {
	//				return ((List<Symbol>) internalRepresentation).retainAll(c.internalRepresentation);
	//			}
	//		}
	//	}
	//
