...
public class BeginPhasePoint extends PhasePoint {
    ...
    /**
     * Stabilizes the phase information, starting with all those begin-phase points that have been marked as stale.
     */
    public static void stabilizeStaleBeginPhasePoints() {
        ...
        for (ParallelConstruct pc : affectedParCons) {
            ...
            firstPhase.stabilizeThisPhase(new HashSet<>(), BeginPhasePoint.staleBeginPhasePoints, stabilizedBPPs, firstPhase);
    ...
    /**
     * Obtain set of all those BeginPhasePoints from which {@code node} may be reachable, on barrier-free path
     * (inclusive).
     * <br>
     * Note that this method would also trigger resetting of {@link #setsInvalid} of all the {@link BeginPhasePoint}
     * nodes, after refreshing the corresponding lists of reachable nodes and barriers.
     * <br>
     * Furthermore, if {@code node} is same as the node field of a BeginPhasePoint, that BeginPhasePoint is also
     * considered as a valid entry to be returned.
     *
     * @param node
     *         node for which we obtain all those BeginPhasePoints from which the node may be reachable.
     *
     * @return set of all those BeginPhasePoints from which {@code node} may be reachable on barrier-free path of same
     ...
     * <br>
     * Note that this method does not attempt addition of other nodes to the reachability set of this phase point.
     *
     * @param nodeToBeAdded
     *         node that has to be added to the reachability set of this phase point.
     */
    ...
    /**
     * Populate the reachable nodes, and next set of barriers, for this node. This method also triggers updates to the
     * PFG, when needed.
     */
    @Deprecated
    ...
    /**
     * This method recomputes the set of reachable nodes and next end-points, without reflecting this change in the
     ...
     * <br>
     * Note that this method does not attempt removal of any other nodes from the reachability set of this phase point.
     *
     * @param node
     *         node that has to be removed from the reachability set of this phase point.
     *
     * @return true, if {@code leafNode} was found in the reachability set and removed.
     */
    ...
    /**
     * Obtain set of all those BeginPhasePoints from which one or more elements of {@code nodeSet} might be reachable.
     * <br>
     * Note that this method would also trigger resetting of {@link #setsInvalid} of all the {@link BeginPhasePoint}
     * nodes, after refreshing the corresponding lists of reachable nodes and barriers.
     *
     * @param nodeSet
     *         set of elements for which we wish to obtain the set of BeginPhasePoints from which one or more elements
     *         of the set are reachable.
     *
     * @return set of BeginPhasePoints from which one or more elements of {@code nodeSet} are reachable on barrier-free
    ...
    /**
     * Adds {@code endPP} to the {@link #nextBarrierSet nextBarrierSet} of this phase point.
     * <br>
     * Note that this method would not have any side-effects on sets of other phase points.
     *
     * @param endPP
     *         a phase point that has to be added in the {@link #nextBarrierSet nextBarrierSet} of this node.
     */
    @Deprecated
     ...
     * <br>
     * Note that this method does not have side-effects on the set of other phase points.
     *
     * @param endPP
     *         an EndPhasePoint that has to be added to the {@link #nextBarrierSet} of this phase point.
     */
    @Deprecated
    ...
    /**
     * Given a new set of next end-phase points (barriers), this method makes appropriate changes to the PFG.
     *
     * @param newNextBarriers
     *         a new set of next end-phase points (barriers), for this begin-phase points.
     */
    @Deprecated
    ...
    /**
     * Given a new set of reachable nodes {@code newNodes}, this method makes appropriate changes to the PFG.
     *
     * @param newNodes
