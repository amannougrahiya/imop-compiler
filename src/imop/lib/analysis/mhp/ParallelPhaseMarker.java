...
//		if (!Misc.isCFGNode(n)) {
//			System.out.println(
//					"Some error in customInitProcess. Node " + n.getClass().getSimpleName() + " isn't a CFG node!");
//			Thread.dumpStack();
//			System.exit(0);
//		}
//
...
//		}
//
//		// Add the phase information to n, and return false if information is already present there.
...
//				//System.out.println("Accepting from endProcess, the node " + successor.getClass().getSimpleName()
...
//			FunctionDefinitionInfo funcDefInfo = (FunctionDefinitionInfo) n.parent.getInfo();
//			assert (callStack.isEmpty());
//			if (callStack.peek() == CallStatement.getPhantomCall()) {
//				/*
//				 * Context-insensitive traversal.
