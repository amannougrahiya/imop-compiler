 ...
 * <br>
 * Each phase starts at a set of barriers, and ends at the next set of reachable barriers. A phase may be SVE-sensitive
 * or -insensitive.
 *
 * @param <B>
...
public abstract class AbstractPhase<B extends AbstractPhasePointable, E extends AbstractPhasePointable> {
    ...
    /**
     * Create a new edge in the phase-flow graph from {@code source} phase to the {@code destination} phase.
     *
     * @param source
    ...
    /**
     * Remove an existing edge in the phase-flow graph from {@code source} phase to {@code destination} phase.
     *
     * @param source
    ...
    /**
     * Removes {@code nodeToBeRemoved} from this phase, and this phase from the node.
     * <br>
    ...
    /**
     * Add the specified end-point to the end-points of this phase. This method does not support automated updates.
     *
     * @return
     */
