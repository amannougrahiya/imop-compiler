...
public class SVEChecker {
	 ...
	 * (These functions are not functions, mathematically speaking.)
	 */
	 ...
	 * @param nodePairs
	 * @return
	 *         true, if all threads will read same value for the private
	 *         variable {@code sym} at the node {@code expression}; false
	 *         otherwise.
	 */
	...
	/**
	 * Checks if node writes single-value for all the threads in any given
	 * phase.
	 * 
	 * @param node
	 *            node that has to be tested.
	 * @return
	 *         true if {@code node} would write same value to a symbol, for any
