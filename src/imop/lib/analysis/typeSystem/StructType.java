...
public class StructType extends DerivedType implements Scopeable {
	...
	private String tag;
	private List<StructOrUnionMember> elementList = new ArrayList<>();
	 ...
	 * the related union.
	 */
	public StructType(String tag, Scopeable definingScope, Declaration declaringNode) {
		this.setTag(tag);
		this.complete = false;
	...
	protected String preDeclarationString() {
		String retString = "struct " + getName() + " ";
		return retString;
	}
