...
public class PredicateAnalysis extends IntraProceduralControlFlowAnalysis<PredicateAnalysis.PredicateFlowFact> {
    ...
    public static class PredicateFlowFact extends FlowAnalysis.FlowFact {
        ...
        /**
         * Given a set of {@link ReversePath}, this method creates the simplified * set of paths by removing all those
        ...
        /**
         * Given a set of {@link ReversePath}, this method creates the simplified paths as follows:
         * <ul>
