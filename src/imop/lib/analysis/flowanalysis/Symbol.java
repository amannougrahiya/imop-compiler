...
public class Symbol extends Cell {
	...
	/**
	 * Declaration, ParameterDeclaration, or FunctionDefinition, which declares
	 * this symbol.
	 * 
	 * @return
	 *         Declaration, ParameterDeclaration, or FunctionDefinition, which
	...
	/**
	 * Enclosing scope (CompoundStatement, FunctionDefinition, or
	 * TranslationUnit) in which this symbol was declared.
	 * 
	 * @return
	 *         enclosing scope (CompoundStatement, FunctionDefinition, or
	 *         TranslationUnit) in which this symbol was declared.
	...
	/**
	 * Creates a new temporary with same assignable type as that of this symbol,
	 * and adds the declaration of the newly created temporary in the scope of
	 * this symbol.
	 * 
	 * @return
	 *         name of the newly created temporary.
	 */
	...
	public ImmutableCellSet getPointsTo(Node node) {
		...
		if (Program.basePointsTo) {
			...
			if (this.type instanceof FunctionType) {
				...
				return new ImmutableCellSet(pointsToSet);
			} else if (this.type instanceof ArithmeticType) {
	...
	/**
	 * Given a node, this method returns the default points-to set for this
	 * Symbol at that node, when no points-to analysis has been run.
	 * 
	 * @param node
	 *            node at which the points-to information is required.
	 * @return
	 *         the base points-to set, which should be returned until points-to
