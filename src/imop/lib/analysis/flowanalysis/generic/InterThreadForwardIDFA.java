...
public abstract class InterThreadForwardIDFA<F extends FlowFact> extends GJDepthFirstCFG<F, F> {
	...
	/**
	 * adds missing information from the out of the corresponding precallnode to
	 * the given {@code incompleteff}, which is the final in state of the given
	...
	/**
	 * This method removes those entries from the flow-map {@code fullFF} that
	 * do not correspond to accessible symbols at the function which the given
	 ...
	 * correspond to local keys of the scope that the given end-node,
	 * {@code node}, ends.
	 * 
	 * @param node
	 *            an end-node.
