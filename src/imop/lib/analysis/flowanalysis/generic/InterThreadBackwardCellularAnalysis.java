...
public abstract class InterThreadBackwardCellularAnalysis<F extends CellularDataFlowAnalysis.CellularFlowMap<?>>
	 ...
	 * correspond to local keys of the scope that the given begin node,
	 * {@code node}, begins.
	 * 
	 * @param node
	 *            an end-node.
	 ...
	 * Note that OUT objects would be reinitialized for all encountered nodes.
	 * 
	 * @param node
	 * @param stateINChanged
	 */
