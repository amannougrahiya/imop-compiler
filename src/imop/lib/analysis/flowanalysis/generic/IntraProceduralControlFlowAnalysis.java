 ...
 */
public abstract class IntraProceduralControlFlowAnalysis<F extends FlowAnalysis.FlowFact> extends ControlFlowAnalysis<F> {
    ...
    /**
     * This method should model the effect of the given call statement on the given flow fact, and return the result.
     *
     * @param callStmt
     * @param newIN
     *
    ...
    /**
     * Given a parameter declaration, this method models the affect of assigning BOTTOM element lattice to the
     * parameter, and returns the resulting updated {@code flowFactOne}.
     *
     * @param parameter
     *         a parameter declaration.
     * @param flowFactOne
     *         a flow-fact on which the affect of parameter's write to BOTTOM has to be modeled.
     *
     * @return a flow-fact that is obtained upon applying the affect of parameter's write to BOTTOM, on {@code
     * flowFactOne}.
     */
