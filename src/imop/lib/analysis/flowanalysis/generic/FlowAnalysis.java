...
public abstract class FlowAnalysis<F extends FlowAnalysis.FlowFact> extends GJDepthFirstProcess<F, F> {
    ...
    /**
     * Super-class for all the specializations of {@code FlowFact}s, which are used to represent the class of data-flow
    ...
    public static abstract class FlowFact {
        ...
        /**
         * Given an instance of a FlowFact {@link other}, this method should be overridden to update the receiver such
         * that it is equal to the meet of the initial state of the receiver with {@link other}.
         * <p>
         * An implementation can use the set of cells, {@link cellSet}, to make the meet more precise. The set {@link
         * cellSet} should contain all those cells which may contribute to the update in data-flow fact of a node.
         * <p>
         ...
         *         </ul>
         *
         * @return true if this flow-fact has been updated as a result of this meet operation.
         */
    ...
    /**
     * Depending upon the nature of the analysis, this method should implement the code that invokes appropriate methods
     * to run the flow analysis, given a function definition. NOTE: The definitions of this method would already be
     * provided in specific subclasses. Client analyses should not override this method.
     *
     * @param funcDef
     */
    ...
    /**
     * f0 ::= OmpPragma() f1 ::= <SOneGLE> f2 ::= SingleClauseList() f3 ::= OmpEol() f4 ::= Statement()
     */
    @Override
