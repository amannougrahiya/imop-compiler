...
public class ReachingDefinitionAnalysis extends InterThreadForwardCellularAnalysis<ReachingDefinitionAnalysis.ReachingDefinitionFlowMap> {
    ...
    public static class ReachingDefinitionFlowMap extends CellularDataFlowAnalysis.CellularFlowMap<ImmutableDefinitionSet> {
    ...
    @Override
    public ReachingDefinitionFlowMap writeToParameter(ParameterDeclaration parameter, SimplePrimaryExpression argument, ReachingDefinitionFlowMap flowFactIN) {
