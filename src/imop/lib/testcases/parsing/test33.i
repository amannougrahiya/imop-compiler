typedef struct {
	unsigned char _x[64] __attribute__((__aligned__(8)));
} omp_lock_t;
typedef struct {
	unsigned char _x[80] __attribute__((__aligned__(8)));
} omp_nest_lock_t;
...
extern int omp_target_memcpy(void *, void *, long unsigned int,
...
extern int omp_target_memcpy_rect(void *, void *, long unsigned int, int,
		...
		const long unsigned int *, const long unsigned int *,
		const long unsigned int *, int, int) __attribute__((__nothrow__));
