...
public class DriverModule {
	 ...
	 * @return
	 *         true, if the number of phases per execution is more than one.
	 */
	 ...
	 *            has to be found.
	 * @return
	 *         maximum length of swap-chain within the node.
	 */
	 ...
	 * {@code phaseSet}, within the loop whose contents are {@code itContents}.
	 * <br>
	 ...
	 * @return
	 *         set of clean-writes (mostly {@link ExpressionStatement} nodes)
	 ...
	 * @param cleanWrites
	 *            set of those nodes which are reachable from BPPs that belong
	 *            to the itSmt, and that start a phase of which the first node
	 *            in the newly added iteration is a part.
	 * @param newBorderNode
	 *            borderNode that separates the new copy with the next.
	 * @return
	 *         true, if any code change was performed.
	 */
	 ...
	 * unrolling factor by one, using {@code origBody}.
	 * <br>
	 ...
	 *            performed.
	 * @return
	 *         true, if any copy was eliminated.
	 */
	 ...
	 *            loop to be tested.
	 * @return
	 *         maximum number of abstract phases that can be encountered in one
	 *         execution of this loop.
	 */
	public static int phaseCountPerExecution(IterationStatement itStmt) {
		...
		for (Phase ph : loopEntryPoint.getInfo().getNodePhaseInfo().getPhaseSet()) {
			 ...
			 */
			if (!ph.getEndPoints().parallelStream()
	 ...
	 * @return
	 *         set of all those phases that either start in this loop, or enter
	 ...
	 * @return
	 *         true if there exists an anti-dependence on a shared variable
	 *         across the back-edge of {@code itStmt}.
	 */
	@SuppressWarnings("unused")
	@Deprecated
