...
public class BasicTransform {
	...
	/**
	 * Replaces a node in the AST with some other node, without changing
	 * anything else.
	 * 
	 * @param baseNode
	 * @param newNode
	 ...
	 * e.g., {S1; S2; S3;} is split into {S1;} {S2;} {S3;}
	 * 
	 * @param node
	 ...
	 * @return
	 *         new node with replacements done as per the nameMap.
	 */
	...
	/**
	 * Pushes the declaration to the least possible index in the enclosing
	 * scope.
	 * 
	 * @param decl
	 ...
	 * declaration such that the initializer has been simplified. This method
	 * returns true, if the simplification was performed.
	 * 
	 * @param decl
