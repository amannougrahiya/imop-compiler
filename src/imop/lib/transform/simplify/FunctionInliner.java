...
public class FunctionInliner {
	 ...
	 * {@code root} that contain a parallel-construct or a barrier within them.
	 * 
	 * @param root
	 ...
	 * @return
	 *         true, if it is possible to inline the given call-statement.
	 */
	...
	/**
	 * Checks whether inlining might be profitable for barrier removal
	 * techniques.
	 * <br>
	 * For now, we consider a call-site to be profitable for inlining if it
	 * contains at least one barrier/parallel construct, and in case of former,
	 * if it contains at least one shared access.
	 * 
	 * @param callStmt
	 *            a call-statement to be inspected.
	 * @return
	 *         true, if the call-statement may contain any barrier or parallel
	 *         construct, along with at least one shared access (if it doesn't
	 *         contain a parallel construct).
	 */
	...
	/**
	 * For now, this method does not suggest any renaming of the types, and
	 * returns false if there is any namespace collision for types of the given
	 * function definition with the type table visible at the call-statement.
	 * <br>
	 * Later, we should modify this function such that it removes all
	 * found conflicts by type renaming.
	 * 
	 * @param funcDef
	 ...
	 * 
	 * @return
	 *         true, if there are no type namespace collisions; false,
	 *         otherwise.
	 */
	 ...
	 * returns false if there is any namespace collision for typedef of the
	 * given function definition with the typedef table visible at the
	 * call-statement.
	 * <br>
	 * Later, we should modify this function such that it removes all
	 * found conflicts by typedef renaming.
	 * 
	 * @param funcDef
	 *            target function definition of {@code callStmt}.
	 * @param callStmt
	 ...
	 * 
	 * @return
	 *         true, if there are no typedef namespace collisions; false,
	 *         otherwise.
	 */
	...
	/**
	 * For now, this method does not suggest any renaming of the labels, and
	 * returns false if there is any namespace collision for labels of the
	 * given function definition with the labels at the caller.
	 * <br>
	 * Later, we should modify this function such that it removes all
	 * found conflicts by label renaming.
	 * 
	 * @param funcDef
	 *            target function definition of {@code callStmt}.
	 * @param callStmt
	 ...
	 * 
	 * @return
	 *         true, if there are no label namespace collisions; false,
	 *         otherwise.
	 */
	 ...
	 * function-definition.
	 * Note that this function may update the function-definition.
	 * 
	 * @param funcDef
	 *            a function-definition.
	 * @return
	 *         true, if all static declarations, if any, have been pushed up to
	 *         the global scope, with proper renaming, if required.
	 */
	...
	/**
	 * Attempts to inline the function called at {@code callStmt}.
	 * If binding of the given call-statement cannot be determined
	 * unambiguously, then this method performs no change and returns
	 * {@code false}.
	 * <br>
	 * Note that labels attached to the {@code callStmt} are shifted to the
	 * first executable statement in the inline code.
	 * 
	 * @param callStmt
	 *            a call-statement to be inlined.
	 * @return
	 *         {@code true}, if the inlining was successful; {@code false}
	 *         otherwise.
	 */
	...
	/**
	 * Ensures that there are no name-conflicts of parameters with variables
	 ...
	 * 
	 * @return
	 *         true, if all parameter name-conflicts have been resolved in the
	 *         provided body.
	 */
	...
	/**
	 * Handles dummy-flushes, variable renaming, and external return statements
	 * on unconnected nodes, to obtain list of nodes to be added.
	 * <br>
	 * Note that later we should unify this method with
	 * {@link #handleInternalReturnStatements(CallStatement, String, Statement)}.
