...
public class MasterConstructCFGInfo extends CFGInfo {

	public MasterConstructCFGInfo(Node owner) {
		super(owner);
	}

	public List<SideEffect> setBody(Statement stmt) {
		List<SideEffect> sideEffectList = new ArrayList<>();
		MasterConstruct owner = (MasterConstruct) this.getOwner();
	...
	public Statement getBody() {
		return (Statement) Misc.getInternalFirstCFGNode(((MasterConstruct) getOwner()).getF3());
	}
