...
public class DataFlowGraph {
	...
	//	 *         between them.
	//	 */
	//	private static boolean dataFactsMayFlowBetween(DummyFlushDirective n1, DummyFlushDirective n2) {
	//		/**
	...
	//
	//			if ((n1EnclosingNode != null) && (n2EnclosingNode != null) && (n1EnclosingNode == n2EnclosingNode)) {
	//				return false;
	//			}
	//		}
	//
	...
	//		//					Deprecated_DataFlowGraph.createInterTaskEdgeBetween(n1LockNode, n2LockNode);
