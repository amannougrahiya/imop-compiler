...
public class DoPredicateLink extends CFGLink {
	public DoStatement enclosingNonLeafNode;
	public Expression childNode;

	public DoPredicateLink(DoStatement enclosingNonLeafNode, Expression childNode) {
