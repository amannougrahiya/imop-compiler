...
public class TaskClauseLink extends CFGLink {
	public TaskConstruct enclosingNonLeafNode;
	public OmpClause childNode;
	public int index;

	public TaskClauseLink(TaskConstruct enclosingNonLeafNode, OmpClause childNode, int index) {
