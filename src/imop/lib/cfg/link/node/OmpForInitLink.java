...
public class OmpForInitLink extends CFGLink {
	public ForConstruct enclosingNonLeafNode;
	public OmpForInitExpression childNode;

	public OmpForInitLink(ForConstruct enclosingNonLeafNode, OmpForInitExpression childNode) {
