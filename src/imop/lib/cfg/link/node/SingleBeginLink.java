...
public class SingleBeginLink extends CFGLink {
	public SingleConstruct enclosingNonLeafNode;
	public BeginNode childNode;

	public SingleBeginLink(SingleConstruct enclosingNonLeafNode, BeginNode childNode) {
