...
public class OmpForTermLink extends CFGLink {
	public ForConstruct enclosingNonLeafNode;
	public OmpForCondition childNode;

	public OmpForTermLink(ForConstruct enclosingNonLeafNode, OmpForCondition childNode) {
