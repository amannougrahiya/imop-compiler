...
public class IfPredicateLink extends CFGLink {
	public IfStatement enclosingNonLeafNode;
	public Expression childNode;

	public IfPredicateLink(IfStatement enclosingNonLeafNode, Expression childNode) {
