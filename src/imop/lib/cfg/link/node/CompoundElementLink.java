...
public class CompoundElementLink extends CFGLink {
	public final CompoundStatement enclosingNonLeafNode;
	public final Node childNode;
	private final int index;

	public CompoundElementLink(CompoundStatement enclosingNonLeafNode, Node childNode, int index) {
		assert (childNode instanceof Statement || childNode instanceof Declaration);
