...
public class OrderedBeginLink extends CFGLink {
	public OrderedConstruct enclosingNonLeafNode;
	public BeginNode childNode;

	public OrderedBeginLink(OrderedConstruct enclosingNonLeafNode, BeginNode childNode) {
