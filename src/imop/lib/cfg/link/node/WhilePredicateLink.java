...
public class WhilePredicateLink extends CFGLink {
	public WhileStatement enclosingNonLeafNode;
	public Expression childNode;

	public WhilePredicateLink(WhileStatement enclosingNonLeafNode, Expression childNode) {
