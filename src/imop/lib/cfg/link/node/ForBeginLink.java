...
public class ForBeginLink extends CFGLink {
	public ForStatement enclosingNonLeafNode;
	public BeginNode childNode;

	public ForBeginLink(ForStatement enclosingNonLeafNode, BeginNode childNode) {
