...
public class ParallelClauseLink extends CFGLink {
	public ParallelConstruct enclosingNonLeafNode;
	public OmpClause childNode;

	public ParallelClauseLink(ParallelConstruct enclosingNonLeafNode, OmpClause childNode) {
