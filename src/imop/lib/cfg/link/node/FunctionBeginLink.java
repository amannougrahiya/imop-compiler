...
public class FunctionBeginLink extends CFGLink {
	public FunctionDefinition enclosingNonLeafNode;
	public BeginNode childNode;

	public FunctionBeginLink(FunctionDefinition enclosingNonLeafNode, BeginNode childNode) {
