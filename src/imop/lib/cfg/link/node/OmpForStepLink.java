...
public class OmpForStepLink extends CFGLink {
	public ForConstruct enclosingNonLeafNode;
	public OmpForReinitExpression childNode;

	public OmpForStepLink(ForConstruct enclosingNonLeafNode, OmpForReinitExpression childNode) {
