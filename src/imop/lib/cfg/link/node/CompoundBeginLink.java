...
public class CompoundBeginLink extends CFGLink {
	public CompoundStatement enclosingNonLeafNode;
	public BeginNode childNode;

	public CompoundBeginLink(CompoundStatement enclosingNonLeafNode, BeginNode childNode) {
