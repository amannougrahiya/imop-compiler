...
public class SwitchPredicateLink extends CFGLink {
	public SwitchStatement enclosingNonLeafNode;
	public Expression childNode;

	public SwitchPredicateLink(SwitchStatement enclosingNonLeafNode, Expression childNode) {
