...
public class CallPostLink extends CFGLink {
	public CallStatement enclosingNonLeafNode;
	public PostCallNode childNode;

	public CallPostLink(CallStatement enclosingNonLeafNode, PostCallNode childNode) {
