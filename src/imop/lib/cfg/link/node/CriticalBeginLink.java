...
public class CriticalBeginLink extends CFGLink {
	public CriticalConstruct enclosingNonLeafNode;
	public BeginNode childNode;

	public CriticalBeginLink(CriticalConstruct enclosingNonLeafNode, BeginNode childNode) {
