...
public class FunctionParameterLink extends CFGLink {
	public FunctionDefinition enclosingNonLeafNode;
	public ParameterDeclaration childNode;
	public int index;

	public FunctionParameterLink(FunctionDefinition enclosingNonLeafNode, ParameterDeclaration childNode, int index) {
