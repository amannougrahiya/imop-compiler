...
public class FunctionBodyLink extends CFGLink {
	public FunctionDefinition enclosingNonLeafNode;
	public CompoundStatement childNode;

	public FunctionBodyLink(FunctionDefinition enclosingNonLeafNode, CompoundStatement childNode) {
