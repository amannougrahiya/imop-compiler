...
public class MasterBeginLink extends CFGLink {
	public MasterConstruct enclosingNonLeafNode;
	public BeginNode childNode;

	public MasterBeginLink(MasterConstruct enclosingNonLeafNode, BeginNode childNode) {
