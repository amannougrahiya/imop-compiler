...
public class InfiExactMultiTypeASTNodesGetter extends DepthFirstProcess {
	public Set<Node> astContents = new HashSet<>();
	Set<Integer> astTypeIds;
	private TraverseExpressions traverseExpressions;

	public InfiExactMultiTypeASTNodesGetter(Set<Integer> searchCodeSet, TraverseExpressions traverseExpressions) {
