 ...
 */
public abstract class SuperStatementVisitor<T extends Node> extends DepthFirstProcess {
	public Collection<T> astContents;

	@Override
	public abstract void endProcess(Node n);
