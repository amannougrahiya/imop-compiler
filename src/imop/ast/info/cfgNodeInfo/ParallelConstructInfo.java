...
public class ParallelConstructInfo extends OmpConstructInfo {
    ...
    /**
     * A factory method that creates a parallel construct info, and also initializes its entry {@link BeginPhasePoint}
    ...
    /**
     * A temporary method. DO NOT USE IT, except at known places! This method does not guarantee automated updates.
     */
    ...
    /**
     * Singleton entry phase corresponding to this parallel construct. Note that this phase's begin-phase point set
     * would consist of a single element, namely the {@link BeginNode} of the parallel construct (which would also be
    ...
    /**
     * A {@link BeginPhasePoint} encapsulating the {@code BeginNode} of this parallel construct, with an empty
     * call-stack.
     *
