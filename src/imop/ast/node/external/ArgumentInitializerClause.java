 ...
 * f6 ::= ")"
 */
public class ArgumentInitializerClause extends Node {
	{
		classId = 113;
	}

	public ArgumentInitializerClause() {
	}

	/**
	 * 
	 */
	private static final long serialVersionUID = -2264172833383255034L;
	private NodeToken f0;
	private NodeToken f1;
	private NodeToken f2;
	private NodeToken f3;
	private ExpressionList f4;
	private NodeToken f5;
	private NodeToken f6;

	public ArgumentInitializerClause(NodeToken n0, NodeToken n1, NodeToken n2, NodeToken n3, ExpressionList n4,
			NodeToken n5, NodeToken n6) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		n3.setParent(this);
	...
	public ArgumentInitializerClause(NodeToken n0, ExpressionList n1) {
		n0.setParent(this);
		n1.setParent(this);
	...
	public ExpressionList getF4() {
		return f4;
	}

	public void setF4(ExpressionList f4) {
		f4.setParent(this);
		this.f4 = f4;
	}
