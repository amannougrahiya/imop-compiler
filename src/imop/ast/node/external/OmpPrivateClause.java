...
import imop.ast.info.OmpPrivateClauseInfo;
 ...
 * f3 ::= ")"
 */
public class OmpPrivateClause extends OmpClause {
	{
		classId *= 379;
	}
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1501875339009254971L;
	private NodeToken f0;
	private NodeToken f1;
	private VariableList f2;
	private NodeToken f3;

	public OmpPrivateClause(NodeToken n0, NodeToken n1, VariableList n2, NodeToken n3) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		n3.setParent(this);
	...
	public OmpPrivateClause(VariableList n0) {
		n0.setParent(this);
		setF0(new NodeToken("private"));
	...
	@Override
	public OmpPrivateClauseInfo getInfo() {
		if (info == null) {
			this.info = new OmpPrivateClauseInfo(this);
		}
		return (OmpPrivateClauseInfo) info;
	}
