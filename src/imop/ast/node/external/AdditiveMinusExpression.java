...
public class AdditiveMinusExpression extends Expression {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6760781235173566675L;
	private NodeToken f0;
	private AdditiveExpression f1;

	public AdditiveMinusExpression(NodeToken n0, AdditiveExpression n1) {
		n0.setParent(this);
		n1.setParent(this);
		setF0(n0);
		setF1(n1);
	...
	public AdditiveMinusExpression(AdditiveExpression n0) {
		n0.setParent(this);
		setF0(new NodeToken("-"));
