...
import imop.ast.info.OmpCopyPrivateClauseInfo;
 ...
 * f3 ::= ")"
 */
public class OmpCopyPrivateClause extends OmpClause {
	{
		classId *= 421;
	}

	public OmpCopyPrivateClause() {
	}

	/**
	 * 
	 */
	private static final long serialVersionUID = -3574147943527854150L;
	private NodeToken f0;
	private NodeToken f1;
	private VariableList f2;
	private NodeToken f3;

	public OmpCopyPrivateClause(NodeToken n0, NodeToken n1, VariableList n2, NodeToken n3) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		n3.setParent(this);
	...
	public OmpCopyPrivateClause(VariableList n0) {
		n0.setParent(this);
		setF0(new NodeToken("copyprivate"));
	...
	@Override
	public OmpCopyPrivateClauseInfo getInfo() {
		if (info == null) {
			this.info = new OmpCopyPrivateClauseInfo(this);
		}
		return (OmpCopyPrivateClauseInfo) info;
	}
