 ...
 */
public class RelationalLEExpression extends RelationalExpression {
	{
		classId = 1039394;
	}

	public RelationalLEExpression() {
	}

	/**
	 * 
	 */
	private static final long serialVersionUID = 131343639316423700L;
	private NodeToken f0;
	private RelationalExpression f1;

	public RelationalLEExpression(NodeToken n0, RelationalExpression n1) {
		n0.setParent(this);
		n1.setParent(this);
		setF0(n0);
		setF1(n1);
	...
	public RelationalLEExpression(RelationalExpression n0) {
		n0.setParent(this);
		setF0(new NodeToken("<="));
