...
import imop.ast.info.cfgNodeInfo.IfClauseInfo;
...
public class IfClause extends OmpClause {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8000939813886303030L;
	private NodeToken f0;
	private NodeToken f1;
	private Expression f2;
	private NodeToken f3;

	public IfClause(NodeToken n0, NodeToken n1, Expression n2, NodeToken n3) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		n3.setParent(this);
	...
	@Override
	public IfClauseInfo getInfo() {
		if (info == null) {
			info = new IfClauseInfo(this);
		}
		return (IfClauseInfo) info;
	}
