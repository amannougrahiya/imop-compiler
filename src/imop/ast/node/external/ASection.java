...
public class ASection extends Node {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2177690173846096567L;
	private OmpPragma f0;
	private NodeToken f1;
	private OmpEol f2;
	private Statement f3;

	public ASection(OmpPragma n0, NodeToken n1, OmpEol n2, Statement n3) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		n3.setParent(this);
	...
	public ASection(OmpPragma n0, OmpEol n1, Statement n2) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		setF0(n0);
		setF1(new NodeToken("section"));
