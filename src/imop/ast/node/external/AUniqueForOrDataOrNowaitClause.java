 ...
 * | NowaitClause()
 */
public class AUniqueForOrDataOrNowaitClause extends Node {
	{
		classId = 73;
	}

	public AUniqueForOrDataOrNowaitClause() {
	}

	/**
	 * 
	 */
	private static final long serialVersionUID = -2165928585768258173L;
	private NodeChoice f0;

	public AUniqueForOrDataOrNowaitClause(NodeChoice n0) {
		n0.setParent(this);
		setF0(n0);
	}
