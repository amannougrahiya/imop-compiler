...
import imop.ast.info.cfgNodeInfo.TaskyieldDirectiveInfo;
...
public class TaskyieldDirective extends OmpDirective {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6208081758509500300L;
	private OmpPragma f0;
	private NodeToken f1;
	private OmpEol f2;

	public TaskyieldDirective(OmpPragma n0, NodeToken n1, OmpEol n2) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		setF0(n0);
	...
	public TaskyieldDirective(OmpPragma n0, OmpEol n1) {
		n0.setParent(this);
		n1.setParent(this);
		setF0(n0);
		setF1(new NodeToken("taskyield"));
	...
	@Override
	public TaskyieldDirectiveInfo getInfo() {
		if (info == null) {
			info = new TaskyieldDirectiveInfo(this);
		}
		return (TaskyieldDirectiveInfo) info;
	}
