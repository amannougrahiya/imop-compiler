 ...
 * f1 ::= <IDENTIFIER>
 */
public class PreIncrementId extends OmpForReinitExpression {
	{
		classId = 63787;
	}

	public PreIncrementId() {
	}

	/**
	 * 
	 */
	private static final long serialVersionUID = -4539819410757422686L;
	private NodeToken f0;
	private NodeToken f1;

	public PreIncrementId(NodeToken n0, NodeToken n1) {
		n0.setParent(this);
		n1.setParent(this);
		setF0(n0);
		setF1(n1);
	...
	public PreIncrementId(NodeToken n0) {
		n0.setParent(this);
		setF0(new NodeToken("++"));
