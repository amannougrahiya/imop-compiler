 ...
 */
public class MultiplicativeOptionalExpression extends Expression {
	{
		classId = 1538;
	}

	public MultiplicativeOptionalExpression() {
	}

	/**
	 * 
	 */
	private static final long serialVersionUID = -9154817291708642316L;
	private NodeChoice f0;

	public MultiplicativeOptionalExpression(NodeChoice n0) {
		n0.setParent(this);
		setF0(n0);
	}
