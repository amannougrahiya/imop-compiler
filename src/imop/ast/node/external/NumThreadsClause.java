...
import imop.ast.info.cfgNodeInfo.NumThreadsClauseInfo;
 ...
 * f3 ::= ")"
 */
public class NumThreadsClause extends OmpClause {
	{
		classId *= 439;
	}

	public NumThreadsClause() {
	}

	/**
	 * 
	 */
	private static final long serialVersionUID = 687731851588426294L;
	private NodeToken f0;
	private NodeToken f1;
	private Expression f2;
	private NodeToken f3;

	public NumThreadsClause(NodeToken n0, NodeToken n1, Expression n2, NodeToken n3) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		n3.setParent(this);
	...
	public NumThreadsClause(Expression n0) {
		n0.setParent(this);
		setF0(new NodeToken("num_threads"));
	...
	@Override
	public NumThreadsClauseInfo getInfo() {
		if (info == null) {
			info = new NumThreadsClauseInfo(this);
		}
		return (NumThreadsClauseInfo) info;
	}
