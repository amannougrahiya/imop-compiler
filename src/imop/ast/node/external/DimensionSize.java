 ...
 * f2 ::= "]"
 */
public class DimensionSize extends Node {
	{
		classId = 1087;
	}
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8828003538097284567L;
	private NodeToken f0;
	private NodeOptional f1;
	private NodeToken f2;

	public DimensionSize(NodeToken n0, NodeOptional n1, NodeToken n2) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		setF0(n0);
	...
	public DimensionSize(NodeOptional n0) {
		n0.setParent(this);
		setF0(new NodeToken("["));
