 ...
 * | TypeQualifier()
 */
public class ASpecifierQualifier extends Node {
	{
		classId = 89;
	}

	public ASpecifierQualifier() {
	}

	/**
	 * 
	 */
	private static final long serialVersionUID = -5224144866276824052L;
	private NodeChoice f0;

	public ASpecifierQualifier(NodeChoice n0) {
		n0.setParent(this);
		setF0(n0);
	}
