...
import imop.ast.info.cfgNodeInfo.TaskwaitDirectiveInfo;
...
public class TaskwaitDirective extends OmpDirective {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5924004088365106557L;
	...
	@Override
	public TaskwaitDirectiveInfo getInfo() {
		if (info == null) {
			info = new TaskwaitDirectiveInfo(this);
		}
		return (TaskwaitDirectiveInfo) info;
	}
