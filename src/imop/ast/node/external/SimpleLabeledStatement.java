 ...
 * f2 ::= Statement()
 */
public class SimpleLabeledStatement extends LabeledStatement {
	{
		classId = 28347;
	}

	public SimpleLabeledStatement() {
	}

	/**
	 * 
	 */
	private static final long serialVersionUID = -8803634603470260576L;
	private NodeToken f0;
	private NodeToken f1;
	private Statement f2;
	...
	public Statement getF2() {
		return f2;
	}

	public void setF2(Statement f2) {
		f2.setParent(this);
		this.f2 = f2;
	}
}
