 ...
 * f1 ::= UnaryExpression()
 */
public class SizeofUnaryExpression extends Expression {
	{
		classId = 1306;
	}

	public SizeofUnaryExpression() {
	}

	/**
	 * 
	 */
	private static final long serialVersionUID = 209346385176050604L;
	private NodeToken f0;
	private UnaryExpression f1;

	public SizeofUnaryExpression(NodeToken n0, UnaryExpression n1) {
		n0.setParent(this);
		n1.setParent(this);
		setF0(n0);
		setF1(n1);
	...
	public SizeofUnaryExpression(UnaryExpression n0) {
		n0.setParent(this);
		setF0(new NodeToken("sizeof"));
