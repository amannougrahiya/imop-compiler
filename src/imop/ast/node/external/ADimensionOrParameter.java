 ...
 */
public class ADimensionOrParameter extends Node {
	{
		classId = 137;
	}

	public ADimensionOrParameter() {
	}

	/**
	 * 
	 */
	private static final long serialVersionUID = 7744022617010304962L;
	private NodeChoice f0;

	public ADimensionOrParameter(NodeChoice n0) {
		n0.setParent(this);
		setF0(n0);
	}
