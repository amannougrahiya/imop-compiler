...
import imop.lib.transform.simplify.StructUnionEnumTagger;
...
public class EnumSpecifier extends Node {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5158570683859043898L;
	private NodeChoice f0;

	public EnumSpecifier(NodeChoice n0) {
		n0.setParent(this);
		setF0(n0);
		this.accept(new StructUnionEnumTagger());
	}
