 ...
 * | DataClause()
 */
public class AUniqueParallelOrUniqueForOrDataClause extends Node {
	{
		classId = 67;
	}

	public AUniqueParallelOrUniqueForOrDataClause() {
	}

	/**
	 * 
	 */
	private static final long serialVersionUID = 4387727280297366602L;
	private NodeChoice f0;

	public AUniqueParallelOrUniqueForOrDataClause(NodeChoice n0) {
		n0.setParent(this);
		setF0(n0);
	}
