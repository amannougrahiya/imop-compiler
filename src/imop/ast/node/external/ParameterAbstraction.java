 ...
 */
public class ParameterAbstraction extends Node {
	{
		classId = 257;
	}

	public ParameterAbstraction() {
	}

	/**
	 * 
	 */
	private static final long serialVersionUID = 3777432800712302377L;
	private NodeChoice f0;

	public ParameterAbstraction(NodeChoice n0) {
		n0.setParent(this);
		setF0(n0);
	}
