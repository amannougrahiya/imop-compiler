...
public class RelationalGTExpression extends RelationalExpression {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5935619647949387345L;
	private NodeToken f0;
	private RelationalExpression f1;

	public RelationalGTExpression(NodeToken n0, RelationalExpression n1) {
		n0.setParent(this);
		n1.setParent(this);
		setF0(n0);
		setF1(n1);
	...
	public RelationalGTExpression(RelationalExpression n0) {
		n0.setParent(this);
		setF0(new NodeToken(">"));
