...
import imop.ast.info.OmpSharedClauseInfo;
 ...
 * f3 ::= ")"
 */
public class OmpSharedClause extends OmpClause {
	{
		classId *= 367;
	}

	public OmpSharedClause() {
	}

	/**
	 * 
	 */
	private static final long serialVersionUID = -273773065600027610L;
	private NodeToken f0;
	private NodeToken f1;
	private VariableList f2;
	private NodeToken f3;

	public OmpSharedClause(NodeToken n0, NodeToken n1, VariableList n2, NodeToken n3) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		n3.setParent(this);
	...
	public OmpSharedClause(VariableList n0) {
		n0.setParent(this);
		setF0(new NodeToken("shared"));
	...
	@Override
	public OmpSharedClauseInfo getInfo() {
		if (info == null) {
			this.info = new OmpSharedClauseInfo(this);
		}
		return (OmpSharedClauseInfo) info;
	}
