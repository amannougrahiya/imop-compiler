...
public class UniqueForCollapse extends Node {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7256740950096812820L;
	private NodeToken f0;
	private NodeToken f1;
	private Expression f2;
	private NodeToken f3;

	public UniqueForCollapse(NodeToken n0, NodeToken n1, Expression n2, NodeToken n3) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		n3.setParent(this);
	...
	public UniqueForCollapse(Expression n0) {
		n0.setParent(this);
		setF0(new NodeToken("collapse"));
