...
public class ArgumentList extends Node {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6367877817257179595L;
	private NodeToken f0;
	private NodeOptional f1;
	private NodeToken f2;

	public ArgumentList(NodeToken n0, NodeOptional n1, NodeToken n2) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		setF0(n0);
	...
	public ArgumentList(NodeOptional n0) {
		n0.setParent(this);
		setF0(new NodeToken("("));
