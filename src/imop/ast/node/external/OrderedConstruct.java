...
import imop.ast.info.cfgNodeInfo.OrderedConstructInfo;
...
public class OrderedConstruct extends OmpConstruct {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4701758713589465172L;
	private OmpPragma f0;
	private NodeToken f1;
	private OmpEol f2;
	private Statement f3;

	public OrderedConstruct(OmpPragma n0, NodeToken n1, OmpEol n2, Statement n3) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		n3.setParent(this);
	...
	public OrderedConstruct(OmpPragma n0, OmpEol n1, Statement n2) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		setF0(n0);
		setF1(new NodeToken("ordered"));
	...
	@Override
	public OrderedConstructInfo getInfo() {
		if (info == null) {
			info = new OrderedConstructInfo(this);
		}
		return (OrderedConstructInfo) info;
	}
