 ...
 * f1 ::= "++"
 */
public class PostIncrementId extends OmpForReinitExpression {
	{
		classId = 73903;
	}

	public PostIncrementId() {
	}

	/**
	 * 
	 */
	private static final long serialVersionUID = -4900770121279939322L;
	private NodeToken f0;
	private NodeToken f1;

	public PostIncrementId(NodeToken n0, NodeToken n1) {
		n0.setParent(this);
		n1.setParent(this);
		setF0(n0);
		setF1(n1);
	...
	public PostIncrementId(NodeToken n0) {
		n0.setParent(this);
		setF0(n0);
		setF1(new NodeToken("++"));
