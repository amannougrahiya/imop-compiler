...
import imop.ast.info.cfgNodeInfo.CriticalConstructInfo;
...
public class CriticalConstruct extends OmpConstruct {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8583720177408500533L;
	...
	public CriticalConstruct(OmpPragma n0, NodeToken n1, NodeOptional n2, OmpEol n3, Statement n4) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		n3.setParent(this);
	...
	public CriticalConstruct(OmpPragma n0, NodeOptional n1, OmpEol n2, Statement n3) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		n3.setParent(this);
		setF0(n0);
		setF1(new NodeToken("critical"));
	...
	@Override
	public CriticalConstructInfo getInfo() {
		if (info == null) {
			info = new CriticalConstructInfo(this);
		}
		return (CriticalConstructInfo) info;
	}
