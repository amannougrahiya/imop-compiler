 ...
 */
public class ShiftOptionalExpression extends Expression {
	{
		classId = 1346;
	}

	public ShiftOptionalExpression() {
	}

	/**
	 * 
	 */
	private static final long serialVersionUID = -8657800188642121524L;
	private NodeChoice f0;

	public ShiftOptionalExpression(NodeChoice n0) {
		n0.setParent(this);
		setF0(n0);
	}
