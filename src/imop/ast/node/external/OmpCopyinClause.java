...
import imop.ast.info.OmpCopyinClauseInfo;
 ...
 * f3 ::= ")"
 */
public class OmpCopyinClause extends OmpClause {
	{
		classId *= 431;
	}

	public OmpCopyinClause() {
	}

	/**
	 * 
	 */
	private static final long serialVersionUID = 9006958717707741722L;
	private NodeToken f0;
	private NodeToken f1;
	private VariableList f2;
	private NodeToken f3;

	public OmpCopyinClause(NodeToken n0, NodeToken n1, VariableList n2, NodeToken n3) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		n3.setParent(this);
	...
	public OmpCopyinClause(VariableList n0) {
		n0.setParent(this);
		setF0(new NodeToken("copyin"));
	...
	@Override
	public OmpCopyinClauseInfo getInfo() {
		if (info == null) {
			this.info = new OmpCopyinClauseInfo(this);
		}
		return (OmpCopyinClauseInfo) info;
	}
