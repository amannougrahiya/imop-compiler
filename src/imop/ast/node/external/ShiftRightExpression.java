...
public class ShiftRightExpression extends Expression {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 254409983099687958L;
	private NodeToken f0;
	private ShiftExpression f1;

	public ShiftRightExpression(NodeToken n0, ShiftExpression n1) {
		n0.setParent(this);
		n1.setParent(this);
		setF0(n0);
		setF1(n1);
	...
	public ShiftRightExpression(ShiftExpression n0) {
		n0.setParent(this);
		setF0(new NodeToken("<<"));
	...
	public ShiftExpression getF1() {
		return f1;
	}

	public void setF1(ShiftExpression f1) {
		f1.setParent(this);
		this.f1 = f1;
	}
}
