 ...
 * f2 ::= Expression()
 */
public class OmpForLTCondition extends Node {
	{
		classId = 283;
	}

	public OmpForLTCondition() {
	}

	/**
	 * 
	 */
	private static final long serialVersionUID = -8452835615785106586L;
	private NodeToken f0;
	private NodeToken f1;
	private Expression f2;

	public OmpForLTCondition(NodeToken n0, NodeToken n1, Expression n2) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		setF0(n0);
	...
	public OmpForLTCondition(NodeToken n0, Expression n1) {
		n0.setParent(this);
		n1.setParent(this);
		setF0(n0);
		setF1(new NodeToken("<"));
