...
import imop.ast.info.cfgNodeInfo.OmpForInitExpressionInfo;
...
public class OmpForInitExpression extends Node {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8337725251570135931L;
	private NodeToken f0;
	private NodeToken f1;
	private Expression f2;

	public OmpForInitExpression(NodeToken n0, NodeToken n1, Expression n2) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		setF0(n0);
	...
	public OmpForInitExpression(NodeToken n0, Expression n1) {
		n0.setParent(this);
		n1.setParent(this);
		setF0(n0);
		setF1(new NodeToken("="));
	...
	@Override
	public OmpForInitExpressionInfo getInfo() {
		if (info == null) {
			info = new OmpForInitExpressionInfo(this);
		}
		return (OmpForInitExpressionInfo) info;
	}
