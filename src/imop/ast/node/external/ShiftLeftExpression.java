...
public class ShiftLeftExpression extends Expression {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3585726765164618785L;
	private NodeToken f0;
	private ShiftExpression f1;

	public ShiftLeftExpression(NodeToken n0, ShiftExpression n1) {
		n0.setParent(this);
		n1.setParent(this);
		setF0(n0);
		setF1(n1);
	...
	public ShiftLeftExpression(ShiftExpression n0) {
		n0.setParent(this);
		setF0(new NodeToken(">>"));
