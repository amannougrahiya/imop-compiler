...
public class RegionPhrase extends Node {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5467129763970749264L;
	private NodeToken f0;
	private NodeToken f1;
	private NodeToken f2;

	public RegionPhrase(NodeToken n0, NodeToken n1, NodeToken n2) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		setF0(n0);
	...
	public RegionPhrase(NodeToken n0) {
		n0.setParent(this);
		setF0(new NodeToken("("));
