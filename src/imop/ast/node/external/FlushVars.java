...
public class FlushVars extends Node {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5980962127980733873L;
	private NodeToken f0;
	private VariableList f1;
	private NodeToken f2;

	public FlushVars(NodeToken n0, VariableList n1, NodeToken n2) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		setF0(n0);
	...
	public FlushVars(VariableList n0) {
		n0.setParent(this);
		setF0(new NodeToken("("));
	...
	public VariableList getF1() {
		return f1;
	}

	public void setF1(VariableList f1) {
		f1.setParent(this);
		this.f1 = f1;
	}
