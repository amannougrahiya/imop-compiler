...
public class LogicalORExpression extends Expression {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -18489263322459931L;
	private LogicalANDExpression f0;
	...
	public LogicalANDExpression getF0() {
		return f0;
	}

	public void setF0(LogicalANDExpression f0) {
		f0.setParent(this);
		this.f0 = f0;
	}
