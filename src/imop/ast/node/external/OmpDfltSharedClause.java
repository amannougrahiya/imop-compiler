...
import imop.ast.info.OmpDfltSharedClauseInfo;
 ...
 * f3 ::= ")"
 */
public class OmpDfltSharedClause extends OmpClause {
	{
		classId *= 401;
	}
	/**
	 * 
	 */
	private static final long serialVersionUID = -399305017853726267L;
	private NodeToken f0;
	private NodeToken f1;
	private NodeToken f2;
	private NodeToken f3;

	public OmpDfltSharedClause(NodeToken n0, NodeToken n1, NodeToken n2, NodeToken n3) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		n3.setParent(this);
	...
	@Override
	public OmpDfltSharedClauseInfo getInfo() {
		if (info == null) {
			this.info = new OmpDfltSharedClauseInfo(this);
		}
		return (OmpDfltSharedClauseInfo) info;
	}
