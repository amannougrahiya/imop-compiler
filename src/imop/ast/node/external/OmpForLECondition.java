...
public class OmpForLECondition extends Node {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3471462930191083710L;
	private NodeToken f0;
	private NodeToken f1;
	private Expression f2;

	public OmpForLECondition(NodeToken n0, NodeToken n1, Expression n2) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		setF0(n0);
	...
	public OmpForLECondition(NodeToken n0, Expression n1) {
		n0.setParent(this);
		n1.setParent(this);
		setF0(n0);
		setF1(new NodeToken("<="));
