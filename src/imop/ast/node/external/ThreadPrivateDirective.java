...
public class ThreadPrivateDirective extends Node {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 282418085050809410L;
	private OmpPragma f0;
	private NodeToken f1;
	private NodeToken f2;
	private VariableList f3;
	...
	public ThreadPrivateDirective(OmpPragma n0, VariableList n1, OmpEol n2) {
		...
		n2.setParent(this);
		setF0(n0);
		setF1(new NodeToken("threadprivate"));
	...
	public VariableList getF3() {
		return f3;
	}

	public void setF3(VariableList f3) {
		f3.setParent(this);
		this.f3 = f3;
	}
