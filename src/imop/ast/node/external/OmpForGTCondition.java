...
public class OmpForGTCondition extends Node {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2034828672248698713L;
	private NodeToken f0;
	private NodeToken f1;
	private Expression f2;

	public OmpForGTCondition(NodeToken n0, NodeToken n1, Expression n2) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		setF0(n0);
	...
	public OmpForGTCondition(NodeToken n0, Expression n1) {
		n0.setParent(this);
		n1.setParent(this);
		setF0(n0);
		setF1(new NodeToken(">"));
