 ...
 * f2 ::= Expression()
 */
public class ShortAssignPlus extends OmpForReinitExpression {
	{
		classId = 87953;
	}

	public ShortAssignPlus() {
	}

	/**
	 * 
	 */
	private static final long serialVersionUID = 7333673633647657261L;
	private NodeToken f0;
	private NodeToken f1;
	private Expression f2;

	public ShortAssignPlus(NodeToken n0, NodeToken n1, Expression n2) {
		n0.setParent(this);
		n1.setParent(this);
		n2.setParent(this);
		setF0(n0);
	...
	public ShortAssignPlus(NodeToken n0, Expression n1) {
		n0.setParent(this);
		n1.setParent(this);
		setF0(n0);
		setF1(new NodeToken("+="));
